...
public final class WWEntityTypes {
	...
	private static DeferredEntityType<Boat> registerBoat(ResourceKey<EntityType<?>> id, DeferredItem<?> item) {
		return registerAbstractBoat(id, EntityTypes.boatFactory(() -> item.get()));
	}
