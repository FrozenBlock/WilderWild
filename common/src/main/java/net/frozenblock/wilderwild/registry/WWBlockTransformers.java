...
// TODO: NeoForge
public final class WWBlockTransformers {
	...
	public static void init() {
		BlockTransformerEvents.ADD_AXE_STRIPPABLE.register((context, addStrippable, registries) -> {
			addStrippable.accept(WWBlocks.BAOBAB_LOG.get(), WWBlocks.STRIPPED_BAOBAB_LOG.get());
			addStrippable.accept(WWBlocks.BAOBAB_WOOD.get(), WWBlocks.STRIPPED_BAOBAB_WOOD.get());
			addStrippable.accept(WWBlocks.WILLOW_LOG.get(), WWBlocks.STRIPPED_WILLOW_LOG.get());
			addStrippable.accept(WWBlocks.WILLOW_WOOD.get(), WWBlocks.STRIPPED_WILLOW_WOOD.get());
			addStrippable.accept(WWBlocks.CYPRESS_LOG.get(), WWBlocks.STRIPPED_CYPRESS_LOG.get());
			addStrippable.accept(WWBlocks.CYPRESS_WOOD.get(), WWBlocks.STRIPPED_CYPRESS_WOOD.get());
			addStrippable.accept(WWBlocks.PALM_LOG.get(), WWBlocks.STRIPPED_PALM_LOG.get());
			addStrippable.accept(WWBlocks.PALM_WOOD.get(), WWBlocks.STRIPPED_PALM_WOOD.get());
			addStrippable.accept(WWBlocks.MAPLE_LOG.get(), WWBlocks.STRIPPED_MAPLE_LOG.get());
			addStrippable.accept(WWBlocks.MAPLE_WOOD.get(), WWBlocks.STRIPPED_MAPLE_WOOD.get());

			addStrippable.accept(WWBlocks.HOLLOWED_ACACIA_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_ACACIA_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_BIRCH_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_BIRCH_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_CHERRY_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_CHERRY_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_DARK_OAK_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_DARK_OAK_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_OAK_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_OAK_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_SPRUCE_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_SPRUCE_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_JUNGLE_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_JUNGLE_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_MANGROVE_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_MANGROVE_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_PALE_OAK_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_PALE_OAK_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_POPLAR_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_POPLAR_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_CRIMSON_STEM.get(), WWBlocks.STRIPPED_HOLLOWED_CRIMSON_STEM.get());
			addStrippable.accept(WWBlocks.HOLLOWED_WARPED_STEM.get(), WWBlocks.STRIPPED_HOLLOWED_WARPED_STEM.get());
			addStrippable.accept(WWBlocks.HOLLOWED_WILLOW_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_WILLOW_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_CYPRESS_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_CYPRESS_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_BAOBAB_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_BAOBAB_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_PALM_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_PALM_LOG.get());
			addStrippable.accept(WWBlocks.HOLLOWED_MAPLE_LOG.get(), WWBlocks.STRIPPED_HOLLOWED_MAPLE_LOG.get());
		});

		BlockTransformerEvents.MODIFY_AXE.register((context, registries) -> {
		...
		BlockTransformerEvents.ON_TRANSFORM.register((context, player, level, pos, itemInHand, oldState, newState) -> {
			if (!WWBlockConfig.LOG_HOLLOWING.get()) return;
			if (newState.is(WWBlockItemTags.HOLLOWED_LOGS.block()) && !oldState.is(WWBlockItemTags.HOLLOWED_LOGS.block())) {
				HollowedLogBlock.spawnHollowParticles(level, newState.getValueOrElse(HollowedLogBlock.AXIS, context.getClickedFace().getAxis()), oldState, pos);
			}
		});
	}

	public static RuleBasedStateProvider.Builder fillWithHollowables(Direction.Axis axis) {
		...
		return RuleBasedStateProvider.builder().ifTrueThenProvide(
