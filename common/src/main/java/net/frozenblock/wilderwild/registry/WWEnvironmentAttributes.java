...
public final class WWEnvironmentAttributes {
	...
	public static final DeferredHolder<EnvironmentAttribute<?>, EnvironmentAttribute<Boolean>> PALE_MUSHROOM_ACTIVE = register(
		"gameplay/pale_mushroom_active",
		() -> EnvironmentAttribute.builder(AttributeTypes.BOOLEAN).defaultValue(false).syncable()
	);
	public static final DeferredHolder<EnvironmentAttribute<?>, EnvironmentAttribute<Boolean>> PLANKTON_GLOWING = register(
		"gameplay/plankton_glowing",
		() -> EnvironmentAttribute.builder(AttributeTypes.BOOLEAN).defaultValue(false)
	);
	public static final DeferredHolder<EnvironmentAttribute<?>, EnvironmentAttribute<Boolean>> SEA_ANEMONE_GLOWING = register(
		"gameplay/sea_anemone_glowing",
		() -> EnvironmentAttribute.builder(AttributeTypes.BOOLEAN).defaultValue(false)
	);
	public static final DeferredHolder<EnvironmentAttribute<?>, EnvironmentAttribute<Float>> OSTRICH_EGG_HATCH_CHANCE = register(
		"gameplay/ostrich_egg_hatch_chance",
		() -> EnvironmentAttribute.builder(AttributeTypes.FLOAT).defaultValue(1F / 18F)
	);
	public static final DeferredHolder<EnvironmentAttribute<?>, EnvironmentAttribute<Float>> PENGUIN_EGG_HATCH_CHANCE = register(
