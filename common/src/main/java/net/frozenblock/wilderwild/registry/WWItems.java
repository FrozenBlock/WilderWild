...
public final class WWItems {
	...
	public static final FrozenDeferredItem<PlaceOnWaterBlockItem> PLANKTON = registerBlockItem(WWBlockItemIds.PLANKTON, WWBlocks.PLANKTON, PlaceOnWaterBlockItem::new);
