...
public final class WWFeatures {
	...
	private static final DeferredRegister<Feature<?>> FEATURE = DeferredRegister.create(
		Registries.FEATURE,
		WWConstants.MOD_ID
	);
	...
	public static final DeferredHolder<Feature<?>, ShelfFungiFeature> SHELF_FUNGI = register("shelf_fungi", () -> new ShelfFungiFeature(ShelfFungiFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, SpongeBudFeature> SPONGE_BUD = register("sponge_bud", () -> new SpongeBudFeature(SpongeBudFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, CattailFeature> CATTAIL = register("cattail", () -> new CattailFeature(CattailFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, WaterCoverFeature> WATER_COVER = register("water_cover", () -> new WaterCoverFeature(WaterCoverFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, TubeWormsFeature> TUBE_WORMS = register("tube_worms", () -> new TubeWormsFeature(NoneFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, HydrothermalVentFeature> HYDROTHERMAL_VENT = register("hydrothermal_vent", () -> new HydrothermalVentFeature(NoneFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, NematocystFeature> NEMATOCYST = register("nematocyst", () -> new NematocystFeature(MultifaceGrowthConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, LargeMesogleaFeature> LARGE_MESOGLEA = register("large_mesoglea", () -> new LargeMesogleaFeature(LargeMesogleaConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, SnowBlanketFeature> SNOW_BLANKET = register("snow_blanket", () -> new SnowBlanketFeature(NoneFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, SnowAndFreezeDiskFeature> SNOW_AND_FREEZE_DISK = register("snow_and_freeze_disk", () -> new SnowAndFreezeDiskFeature(SnowAndIceDiskFeatureConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, PalmTreeFeature> PALM_TREE = register("palm_tree", () -> new PalmTreeFeature(TreeConfiguration.CODEC));
	public static final DeferredHolder<Feature<?>, HugePaleMushroomFeature> HUGE_PALE_MUSHROOM = register("huge_pale_mushroom", () -> new HugePaleMushroomFeature(HugeMushroomFeatureConfiguration.CODEC));
	...
	private static <FC extends FeatureConfiguration, T extends Feature<FC>> DeferredHolder<Feature<?>, T> register(String name, Supplier<T> feature) {
