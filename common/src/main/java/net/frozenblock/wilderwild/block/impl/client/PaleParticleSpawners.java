...
import net.frozenblock.lib.particle.client.api.ParticleSpawner;
...
@ClientOnly
public final class PaleParticleSpawners {
	public static final ParticleSpawner PALE_SPORE_SPAWNER = new ParticleSpawner(
		0.25F,
		7,
		3,
		-3,
	...
	public static final ParticleSpawner FOG_SPAWNER = new ParticleSpawner(
