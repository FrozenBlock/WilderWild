...
public final class FlowerField extends FrozenLibBiome {
	...
	public void fillEnvironmentAttributes(EnvironmentAttributeMap.Builder builder) {
		...
		builder.set(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_FLOWER_FOREST));
	}
	...
	public void addSpawns(MobSpawnSettings.Builder spawns) {
		...
		spawns.addSpawn(MobCategory.CREATURE, 8, new MobSpawnSettings.SpawnerData(EntityTypes.RABBIT, 2, 5));
	}

	@Override
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		if (WWModIntegrations.isBiolithRegisteredAndLoaded()) return;
		if (!WWWorldgenConfig.FLOWER_FIELD_GENERATION.get()) return;
