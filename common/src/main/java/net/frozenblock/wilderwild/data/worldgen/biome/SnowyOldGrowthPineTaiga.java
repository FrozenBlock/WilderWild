...
public final class SnowyOldGrowthPineTaiga extends FrozenLibBiome {
	...
	public void fillEnvironmentAttributes(EnvironmentAttributeMap.Builder builder) {
		...
		builder.set(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_OLD_GROWTH_TAIGA));
	}
	...
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		...
		if (!WWWorldgenConfig.SNOWY_OLD_GROWTH_PINE_TAIGA_GENERATION.get()) return;
