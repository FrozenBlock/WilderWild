...
public final class TemperateRainforest extends FrozenLibBiome {
	...
	public void fillEnvironmentAttributes(EnvironmentAttributeMap.Builder builder) {
		...
		builder.set(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_SPARSE_JUNGLE));
	}
