...
public class TermiteParticle extends TextureSheetParticle {
    ...
    TermiteParticle(ClientLevel level, double x, double y, double z,
    ...
    public void tick() {
        ...
        if (!this.removed) {
            this.setSprite(
                    spriteProvider.get(this.random.nextInt(this.lifetime),
                            this.lifetime));
        }
    }
    ...
    public record Factory(SpriteSet spriteProvider)
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType,
                                       ...
                                       double i) {
            TermiteParticle termite =
                    new TermiteParticle(clientLevel, x, y, z, g, h, i,
                            this.spriteProvider);
            termite.setAlpha(1);
