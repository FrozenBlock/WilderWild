...
public final class WWClientNetworking {
	...
	public static void receiveWindExtensionSyncPacket() {
		ClientPlayNetworking.registerGlobalReceiver(WWWindPacket.PACKET_TYPE, (packet, ctx, sender) -> {
	...
	public static void receiveJellyfishStingPacket() {
		ClientPlayNetworking.registerGlobalReceiver(WWJellyfishStingPacket.PACKET_TYPE, (packet, ctx, sender) -> {
	...
	public static void receiveLightningStrikePacket() {
		ClientPlayNetworking.registerGlobalReceiver(WWLightningStrikePacket.PACKET_TYPE, (packet, ctx, sender) -> {
	...
	public static void receiveScorchingFirePlacePacket() {
		ClientPlayNetworking.registerGlobalReceiver(WWScorchingFirePlacePacket.PACKET_TYPE, (packet, ctx, sender) -> {
			ClientLevel clientLevel = ctx.clientLevel;
