...
public final class BirchTaiga extends FrozenBiome {
	...
	public static final BirchTaiga INSTANCE = new BirchTaiga();
	...
	public void addFeatures(BiomeGenerationSettings.Builder features) {
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.BIRCH_TAIGA_TREES.getKey());
	...
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		...
		if (!WWWorldgenConfig.get().biomeGeneration.generateBirchTaiga) return;
