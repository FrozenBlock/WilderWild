...
public final class OldGrowthBirchTaiga extends FrozenBiome {
	...
	public void addFeatures(@NotNull BiomeGenerationSettings.Builder features) {
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.OLD_GROWTH_BIRCH_TAIGA_TREES.getKey());
	...
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		if (WWWorldgenConfig.get().biomeGeneration.generateOldGrowthBirchTaiga && !WWModIntegrations.biolithLoaded) {
