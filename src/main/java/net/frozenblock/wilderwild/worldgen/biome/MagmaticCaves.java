...
public final class MagmaticCaves extends FrozenBiome {
	...
	public void addSpawns(MobSpawnSettings.Builder spawns) {
		...
		spawns.addSpawn(MobCategory.MONSTER, 75, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE, 4, 4));
		spawns.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_VILLAGER, 1, 1));
		spawns.addSpawn(MobCategory.MONSTER, 75, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
