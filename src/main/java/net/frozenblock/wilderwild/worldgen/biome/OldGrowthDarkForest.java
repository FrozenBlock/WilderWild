...
public final class OldGrowthDarkForest extends FrozenBiome {
	...
	public static final OldGrowthDarkForest INSTANCE = new OldGrowthDarkForest();
	...
	public void addFeatures(@NotNull BiomeGenerationSettings.Builder features) {
		...
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.OLD_GROWTH_DARK_FOREST_VEGETATION.getKey());
	}
	...
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		if (WWWorldgenConfig.get().biomeGeneration.generateOldGrowthDarkForest && !WWModIntegrations.biolithLoaded) {
