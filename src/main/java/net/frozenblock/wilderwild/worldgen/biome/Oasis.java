...
public final class Oasis extends FrozenBiome {
	...
	public void addFeatures(@NotNull BiomeGenerationSettings.Builder features) {
		...
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_SUGAR_CANE);
		...
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.PALMS_OASIS.getKey());
