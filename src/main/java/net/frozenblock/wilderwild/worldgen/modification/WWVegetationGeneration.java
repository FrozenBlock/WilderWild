			...
			.add(ModificationPhase.ADDITIONS,
				...
				(biomeSelectionContext, context) -> {
					if (WWWorldgenConfig.get().mushroomGeneration) {
						...
						if (biomeSelectionContext.hasTag(WWBiomeTags.HAS_BROWN_SHELF_FUNGUS)) {
							generationSettings.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, WWPlacedFeatures.BROWN_SHELF_FUNGUS_PLACED.getKey());
						}

						if (biomeSelectionContext.hasTag(WWBiomeTags.HAS_RED_SHELF_FUNGUS)) {
							generationSettings.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, WWPlacedFeatures.RED_SHELF_FUNGUS_PLACED.getKey());
						}
