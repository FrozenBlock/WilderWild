		...
		BiomeModifications.create(WWConstants.id("modify_ambience_deep_dark")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.DEEP_DARK_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_DEEP_DARK_LOOP, WWSounds.AMBIENT_DEEP_DARK_ADDITIONS, 0.005D);
				}
			});
		...
		BiomeModifications.create(WWConstants.id("modify_ambience_dripstone_caves")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.DRIPSTONE_CAVES_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_DRIPSTONE_CAVES_LOOP, WWSounds.AMBIENT_DRIPSTONE_CAVES_ADDITIONS, 0.01D);
				}
			});
		...
		BiomeModifications.create(WWConstants.id("modify_ambience_lush_caves")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.LUSH_CAVES_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_LUSH_CAVES_LOOP, WWSounds.AMBIENT_LUSH_CAVES_ADDITIONS, 0.01D);
				}
			});
		...
		BiomeModifications.create(WWConstants.id("modify_ambience_frozen_caves")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.FROZEN_CAVES_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_FROZEN_CAVES_LOOP, WWSounds.AMBIENT_FROZEN_CAVES_ADDITIONS, 0.003D);
				}
			});
		...
		BiomeModifications.create(WWConstants.id("modify_ambience_mesoglea_caves")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.MESOGLEA_CAVES_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_MESOGLEA_CAVES_LOOP, WWSounds.AMBIENT_MESOGLEA_CAVES_ADDITIONS, 0.005D);
				}
			});
		...
		BiomeModifications.create(WWConstants.id("modify_ambience_magmatic_caves")).add(
			...
			context -> {
				if (WWAmbienceAndMiscConfig.MAGMATIC_CAVES_AMBIENCE.get()) {
					setBiomeAmbience(context, WWSounds.AMBIENT_MAGMATIC_CAVES_LOOP, WWSounds.AMBIENT_MAGMATIC_CAVES_ADDITIONS, 0.005D);
				}
			});
	}
