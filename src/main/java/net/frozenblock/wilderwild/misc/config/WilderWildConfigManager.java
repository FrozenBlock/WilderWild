...
public class WilderWildConfigManager {
    //COPIED FROM MOD MENU
    ...
    private static void load() {
        ...
        try {
            ...
            System.err.println("Couldn't load Wilder Wild configuration file; reverting to defaults");
            e.printStackTrace();
        }
    }
    ...
    public static void save() {
        ...
        try (FileWriter fileWriter = new FileWriter(file)) {
            ...
            System.err.println("Couldn't save Wilder Wild configuration file");
            e.printStackTrace();
        }
    }
}
