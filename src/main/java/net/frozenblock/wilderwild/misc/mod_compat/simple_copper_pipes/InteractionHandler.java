    ...
    public static boolean addHornNbtToBlock(ServerLevel level, BlockPos pos, Entity owner) {
        ...
        if (entity != null) {
            if (entity instanceof CopperPipeEntity pipe) {
                level.playSound(null, pos, Objects.requireNonNull(BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("lunade", "block.copper_pipe.item_in"))), SoundSource.BLOCKS, 0.2F, (level.random.nextFloat() * 0.25F) + 0.8F);
