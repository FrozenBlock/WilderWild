...
public class WilderOverworldRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry,
        ...
        this.addModifiedVanillaOverworldBiomes(mapper, builder -> {
            ...
            builder.replaceBiome(Biomes.OLD_GROWTH_BIRCH_FOREST,
                    RegisterWorldgen.MIXED_FOREST);


            // DON'T CHANGE THESE PARAMETERS. THESE ARE THE PARAMETERS OF SWAMPS
            List<Climate.ParameterPoint> swampPointsCypress =
                    new ParameterUtils.ParameterPointListBuilder()
                            .temperature(
                                    Climate.Parameter.span(Temperature.COOL,
                                            Temperature.NEUTRAL))
                            .humidity(Humidity.FULL_RANGE)
                            .continentalness(Climate.Parameter.span(
            ...
            List<Climate.ParameterPoint> mangroveSwampPointsCypress =
                    new ParameterUtils.ParameterPointListBuilder()
                            .temperature(
                                    Climate.Parameter.span(Temperature.WARM,
                                            Temperature.HOT))
                            .humidity(Humidity.FULL_RANGE)
                            .continentalness(Climate.Parameter.span(
                                    Continentalness.NEAR_INLAND,
            ...
            List<Climate.ParameterPoint> dripstoneCavesPoints =
                    new ParameterUtils.ParameterPointListBuilder()
                            .temperature(Temperature.FULL_RANGE)
                            .humidity(Humidity.FULL_RANGE)
                            .continentalness(Climate.Parameter.span(0.8F, 1))
            ...
            if (ClothConfigInteractionHandler.modifyMangroveSwampPlacement()) {
                // DON'T CHANGE THESE PARAMETERS. THESE ARE THE PARAMETERS OF MANGROVE SWAMPS
                List<Climate.ParameterPoint> mangroveSwampPoints =
                        new ParameterUtils.ParameterPointListBuilder()
                                .temperature(
                                        Climate.Parameter.span(Temperature.WARM,
                                                Temperature.HOT))
            ...
            if (ClothConfigInteractionHandler.modifySwampPlacement()) {
                // DON'T CHANGE THESE PARAMETERS. THESE ARE THE PARAMETERS OF SWAMPS
                List<Climate.ParameterPoint> swampPoints =
                        new ParameterUtils.ParameterPointListBuilder()
                                .temperature(
                                        Climate.Parameter.span(Temperature.COOL,
                                                Temperature.NEUTRAL))
