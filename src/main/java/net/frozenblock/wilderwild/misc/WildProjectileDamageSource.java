...
public class WildProjectileDamageSource extends IndirectEntityDamageSource {
    ...
    public static DamageSource ancientHorn(Entity projectile, @Nullable Entity attacker) {
        return new WildProjectileDamageSource("ancient_horn", projectile, attacker).bypassArmor();
    }
