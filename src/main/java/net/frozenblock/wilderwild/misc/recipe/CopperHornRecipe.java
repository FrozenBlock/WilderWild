...
public class CopperHornRecipe extends ShapedRecipe {
	...
	public CopperHornRecipe(ResourceLocation location, CraftingBookCategory category) {
		super(location, "wilderwild_copper_horn", category, 3, 2, NonNullList.of(Ingredient.EMPTY, Ingredient.of(Items.COPPER_INGOT), Ingredient.of(Items.GOAT_HORN), Ingredient.of(Items.COPPER_INGOT), Ingredient.of(Items.AIR), Ingredient.of(Items.COPPER_INGOT), Ingredient.of(Items.AIR)), new ItemStack(RegisterItems.COPPER_HORN));
	}
