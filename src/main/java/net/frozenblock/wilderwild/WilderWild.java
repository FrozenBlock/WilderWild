...
import net.frozenblock.wilderwild.world.generation.features.NewSnowAndFreezeFeature;
...
public final class WilderWild extends FrozenMobCategoryEntrypoint implements ModInitializer {
	...
	public static final NewSnowAndFreezeFeature NEW_SNOW_AND_FREEZE_FEATURE = new NewSnowAndFreezeFeature(NoneFeatureConfiguration.CODEC);
    ...
    public void onInitialize() {
		...
		Registry.register(BuiltInRegistries.FEATURE, WilderSharedConstants.id("snow_and_freeze_disk_feature"), SNOW_AND_FREEZE_DISC_FEATURE);
		Registry.register(BuiltInRegistries.FEATURE, WilderSharedConstants.id("new_snow_and_freeze_feature"), NEW_SNOW_AND_FREEZE_FEATURE);
