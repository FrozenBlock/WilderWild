...
public abstract class SwampHutMixin {
        ...
        private SwampHutGenerator swampHut = SwampHutGenerator.class.cast(this);
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            if (swampHut.adjustToAverageHeight(world, chunkBox, 0)) {
                ...
                swampHut.addBlock(world, Blocks.MANGROVE_FENCE.getDefaultState(), 2, 3, 2, chunkBox);
                swampHut.addBlock(world, Blocks.MANGROVE_FENCE.getDefaultState(), 3, 3, 7, chunkBox);
                ...
                swampHut.addBlock(world, Blocks.MANGROVE_FENCE.getDefaultState(), 1, 2, 1, chunkBox);
                swampHut.addBlock(world, Blocks.MANGROVE_FENCE.getDefaultState(), 5, 2, 1, chunkBox);
                ...
                swampHut.addBlock(world, (BlockState)blockState.with(StairsBlock.SHAPE, StairShape.OUTER_RIGHT), 0, 4, 1, chunkBox);
                swampHut.addBlock(world, (BlockState)blockState.with(StairsBlock.SHAPE, StairShape.OUTER_LEFT), 6, 4, 1, chunkBox);
                swampHut.addBlock(world, (BlockState)blockState4.with(StairsBlock.SHAPE, StairShape.OUTER_LEFT), 0, 4, 8, chunkBox);
                swampHut.addBlock(world, (BlockState)blockState4.with(StairsBlock.SHAPE, StairShape.OUTER_RIGHT), 6, 4, 8, chunkBox);
