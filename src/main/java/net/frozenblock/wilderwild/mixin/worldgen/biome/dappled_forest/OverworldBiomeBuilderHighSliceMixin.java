...
public final class OverworldBiomeBuilderHighSliceMixin {
	...
	public void wilderWild$highCoastToNearInlandA(
		...
		if (false && second.equals(Biomes.DAPPLED_FOREST) && WWWorldgenConfig.MAPLE_FOREST_GENERATION.get()) {
			WWConstants.log("Replacing Dappled Forest High: Coast -> Near Inland A", WWConstants.UNSTABLE_LOGGING);
	...
	public void wilderWild$highMidInland(
		OverworldBiomeBuilder instance,
		Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> biomes,
		Climate.Parameter temperature,
		Climate.Parameter humidity,
		...
		// Disabled for balance
		if (false && second.equals(Biomes.DAPPLED_FOREST) && WWWorldgenConfig.MAPLE_FOREST_GENERATION.get()) {
			WWConstants.log("Replacing Dappled Forest High: Near Inland -> Far Inland", WWConstants.UNSTABLE_LOGGING);
	...
	public void wilderWild$highCoastToFarInlandA(
		OverworldBiomeBuilder instance,
		Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> biomes,
		Climate.Parameter temperature,
		Climate.Parameter humidity,
		...
		if (second.equals(Biomes.DAPPLED_FOREST) && WWWorldgenConfig.MAPLE_FOREST_GENERATION.get()) {
			WWConstants.log("Replacing Dappled Forest High: Coast -> Far Inland A", WWConstants.UNSTABLE_LOGGING);
			operation.call(instance, biomes, MapleForest.TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, WWBiomes.MAPLE_FOREST);
			operation.call(instance, biomes, MapleForest.DAPPLED_TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, second);
			return;
		}
	...
	public void wilderWild$highCoastToNearInlandB(
		OverworldBiomeBuilder instance,
		Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> biomes,
		Climate.Parameter temperature,
		Climate.Parameter humidity,
		...
		if (second.equals(Biomes.DAPPLED_FOREST) && WWWorldgenConfig.MAPLE_FOREST_GENERATION.get()) {
			WWConstants.log("Replacing Dappled Forest High: Coast -> Near Inland B", WWConstants.UNSTABLE_LOGGING);
			operation.call(instance, biomes, MapleForest.TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, WWBiomes.MAPLE_FOREST);
			operation.call(instance, biomes, MapleForest.DAPPLED_TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, second);
			return;
		}
	...
	public void wilderWild$highCoastToFarInlandB(
		OverworldBiomeBuilder instance,
		Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> biomes,
		Climate.Parameter temperature,
		Climate.Parameter humidity,
		...
		if (second.equals(Biomes.DAPPLED_FOREST) && WWWorldgenConfig.MAPLE_FOREST_GENERATION.get()) {
			WWConstants.log("Replacing Dappled Forest High: Coast -> Far Inland B", WWConstants.UNSTABLE_LOGGING);
			operation.call(instance, biomes, MapleForest.TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, WWBiomes.MAPLE_FOREST);
			operation.call(instance, biomes, MapleForest.DAPPLED_TEMPERATURE, humidity, continentalness, erosion, weirdness, offset, second);
			return;
		}
