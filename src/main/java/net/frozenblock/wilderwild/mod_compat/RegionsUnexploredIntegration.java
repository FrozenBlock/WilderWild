...
public class RegionsUnexploredIntegration extends ModIntegration {
	...
	public void init() {
		...
		BlockSoundTypeOverwrites.addBlock(id("cactus_flower"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("tassel"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("day_lily"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("aster"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("bleeding_heart"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("blue_lupine"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("daisy"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("dorcel"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("felicia_daisy"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("fireweed"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("hibiscus"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("mallow"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("hyssop"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("pink_lupine"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("poppy_bush"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("salmon_poppy_bush"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("purple_lupine"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("red_lupine"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("waratah"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("tsubaki"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("white_trillium"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("wilting_trillium"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("yellow_lupine"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("red_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("orange_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("yellow_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("lime_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("green_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("cyan_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("light_blue_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("blue_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("purple_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("magenta_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("pink_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("brown_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("white_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("light_gray_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("gray_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("black_snowbelle"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("hyacinth_flowers"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("orange_coneflower"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("purple_coneflower"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("blue_magnolia_flowers"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("pink_magnolia_flowers"), FLOWER, flowerCondition);
		BlockSoundTypeOverwrites.addBlock(id("white_magnolia_flowers"), FLOWER, flowerCondition);
