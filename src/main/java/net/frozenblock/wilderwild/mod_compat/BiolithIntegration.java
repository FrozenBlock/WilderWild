...
public class BiolithIntegration extends ModIntegration {
	...
	public void init() {
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateAridForest) {
			BiomePlacement.addSubOverworld(Biomes.DESERT, WWBiomes.ARID_FOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.1F),
					CriterionBuilder.neighbor(Biomes.FOREST)))));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateAridSavanna) {
			BiomePlacement.addSubOverworld(Biomes.SAVANNA, WWBiomes.ARID_SAVANNA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.1F),
					CriterionBuilder.neighbor(Biomes.DESERT)))));
			BiomePlacement.addSubOverworld(Biomes.DESERT, WWBiomes.ARID_SAVANNA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.FOREST)))));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateBirchJungle) {
			BiomePlacement.addSubOverworld(Biomes.JUNGLE, WWBiomes.BIRCH_JUNGLE,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
						CriterionBuilder.neighbor(Biomes.BIRCH_FOREST))),
					(allOf(CriterionBuilder.ratioMax(
							RatioTargets.EDGE, 0.2F),
						CriterionBuilder.neighbor(
							Biomes.OLD_GROWTH_BIRCH_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.BIRCH_FOREST, WWBiomes.BIRCH_JUNGLE,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.JUNGLE)))));
			BiomePlacement.addSubOverworld(Biomes.OLD_GROWTH_BIRCH_FOREST,
				WWBiomes.BIRCH_JUNGLE,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.JUNGLE)))));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateBirchTaiga) {
			BiomePlacement.addSubOverworld(Biomes.TAIGA, WWBiomes.BIRCH_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
						CriterionBuilder.neighbor(Biomes.BIRCH_FOREST))),
					(allOf(CriterionBuilder.ratioMax(
							RatioTargets.EDGE, 0.2F),
						CriterionBuilder.neighbor(
							Biomes.OLD_GROWTH_BIRCH_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.BIRCH_FOREST, WWBiomes.BIRCH_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.TAIGA)))));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateDarkBirchForest) {
			BiomePlacement.addSubOverworld(Biomes.BIRCH_FOREST,
			...
			BiomePlacement.addSubOverworld(Biomes.OLD_GROWTH_BIRCH_FOREST,
				...
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.DARK_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.DARK_FOREST,
				WWBiomes.DARK_BIRCH_FOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
						CriterionBuilder.neighbor(Biomes.BIRCH_FOREST))),
					(allOf(CriterionBuilder.ratioMax(
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateDarkTaiga) {
			BiomePlacement.addSubOverworld(Biomes.OLD_GROWTH_PINE_TAIGA,
				WWBiomes.DARK_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.DARK_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.DARK_FOREST, WWBiomes.DARK_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateOldGrowthBirchTaiga) {
			BiomePlacement.addSubOverworld(Biomes.OLD_GROWTH_BIRCH_FOREST,
				WWBiomes.OLD_GROWTH_BIRCH_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.TAIGA)))));
			BiomePlacement.addSubOverworld(Biomes.TAIGA,
				WWBiomes.OLD_GROWTH_BIRCH_TAIGA,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(
						Biomes.OLD_GROWTH_BIRCH_FOREST)))));
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateParchedForest) {
			BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.PARCHED_FOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.SAVANNA)))));
			BiomePlacement.addSubOverworld(Biomes.SAVANNA, WWBiomes.PARCHED_FOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.FOREST)))));
		}
      ...
      anyOf((allOf(CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
      -0.15F, 0.55F), CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
      -0.1F, 0.1F),
      ...
      OverworldBiomeBuilderParameters.points(Biomes.FOREST)) { if
      (point.temperature().equals(Temperature.WARM)) {
                  BiomePlacement.addSubOverworld(Biomes.FOREST,
      WWBiomes.RAINFOREST,
      anyOf((allOf(CriterionBuilder.neighbor(Biomes.JUNGLE),
      ...
      CriterionBuilder.value(BiomeParameterTargets.HUMIDITY, 0.075F,
      0.225F)))));
          }
      }*/
			BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.RAINFOREST,
				anyOf((allOf(CriterionBuilder.neighbor(Biomes.JUNGLE))),
					(allOf(CriterionBuilder.neighbor(
						Biomes.BAMBOO_JUNGLE)))));
			BiomePlacement.addSubOverworld(Biomes.JUNGLE, WWBiomes.RAINFOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.1F),
					CriterionBuilder.neighbor(Biomes.FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.BAMBOO_JUNGLE, WWBiomes.RAINFOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.1F),
					CriterionBuilder.neighbor(Biomes.FOREST)))));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateSemiBirchForest) {
			BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.SEMI_BIRCH_FOREST,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(Biomes.BIRCH_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.BIRCH_FOREST,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateSparseBirchJungle) {
			BiomePlacement.addSubOverworld(Biomes.SPARSE_JUNGLE,
				WWBiomes.SPARSE_BIRCH_JUNGLE,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
					CriterionBuilder.neighbor(
						Biomes.OLD_GROWTH_BIRCH_FOREST)))));
			BiomePlacement.addSubOverworld(Biomes.OLD_GROWTH_BIRCH_FOREST,
				WWBiomes.SPARSE_BIRCH_JUNGLE,
				anyOf((allOf(CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.3F),
					CriterionBuilder.neighbor(Biomes.SPARSE_JUNGLE)))));
		}
			...
			if (WWWorldgenConfig.get().biomeGeneration.generateDyingForest) {
				BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.SPARSE_FOREST,
					anyOf((allOf(
						...
						CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.3F,
							0F)))));
				...
				BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.SPARSE_FOREST,
					anyOf((allOf(
						...
						CriterionBuilder.neighbor(Biomes.PLAINS),
						CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.45F,
							0F)))));
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.SPARSE_FOREST,
					anyOf((allOf(
						CriterionBuilder.ratioMax(RatioTargets.EDGE, 0.2F),
    ...
    /*		if (WWWorldgenConfig.get().biomeGeneration.generateWarmBeach) {
                            BiomePlacement.addSubOverworld(Biomes.BEACH,
       WWBiomes.WARM_BEACH,
       allOf(CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE, 0.2F,
       0.55F)));
                    }
                    if
       (WWWorldgenConfig.get().biomeGeneration.generateWarmRiver) {
                            BiomePlacement.addSubOverworld(Biomes.RIVER,
       WWBiomes.WARM_RIVER,
       allOf(CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE, 0.2F,
       0.55F),CriterionBuilder.value(BiomeParameterTargets.HUMIDITY, -0.1F,
       0F))); if (WWWorldgenConfig.get().biomePlacement.modifyJunglePlacement) {
                                    BiomePlacement.addSubOverworld(Biomes.RIVER,
       WWBiomes.WARM_RIVER,
       allOf(CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE, 0.55F,
       1F),CriterionBuilder.value(BiomeParameterTargets.HUMIDITY, 0F, 1F)));
                            }
                            else {
                                    BiomePlacement.addSubOverworld(Biomes.RIVER,
       WWBiomes.WARM_RIVER,
       ...
       1F)));
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateDyingForest) {
      /*			if
         (WWWorldgenConfig.get().biomeGeneration.generateTundra) {
                                  BiomePlacement.addSubOverworld(Biomes.FOREST,
         WWBiomes.DYING_FOREST,
         anyOf(allOf(CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
         -0.495F,
         -0.300F),CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
         -0.105F, 0.050F),CriterionBuilder.value(BiomeParameterTargets.EROSION,
         0.05F, 0.45F))));
                          }
                          else {
                                  BiomePlacement.addSubOverworld(Biomes.FOREST,
         ...
         0.05F, 0.45F))));
			...
			BiomePlacement.addSubOverworld(Biomes.FOREST, WWBiomes.DYING_FOREST,
				anyOf(allOf(
					anyOf(CriterionBuilder.neighbor(Biomes.SNOWY_PLAINS),
					...
					CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
						-0.45F, 0.15F))));
      /*			for (Climate.ParameterPoint point :
         OverworldBiomeBuilderParameters.points(Biomes.FOREST)) { boolean
         generateTundra = WWWorldgenConfig.get().biomeGeneration.generateTundra;
                                  BiomePlacement.addOverworld(WWBiomes.DYING_FOREST,
                                          new Climate.ParameterPoint(
                                                  generateTundra ?
         DyingForest.TEMPERATURE_TUNDRA : DyingForest.TEMPERATURE,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateDyingMixedForest) {
			if (WWWorldgenConfig.get().biomeGeneration.generateTundra) {
				BiomePlacement.addSubOverworld(Biomes.TAIGA,
					...
					anyOf(allOf(CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.495F,
							-0.300F),
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							-0.105F, 0.050F))));
			} else {
				BiomePlacement.addSubOverworld(Biomes.TAIGA,
					WWBiomes.DYING_MIXED_FOREST,
					anyOf(allOf(CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.465F,
							-0.300F),
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							-0.105F, 0.050F))));
			}
      /*for (Climate.ParameterPoint point :
      OverworldBiomeBuilderParameters.points(Biomes.SNOWY_TAIGA)) { boolean
      generateTundra = WWWorldgenConfig.get().biomeGeneration.generateTundra;
          BiomePlacement.addOverworld(WWBiomes.DYING_MIXED_FOREST,
                  new Climate.ParameterPoint(
                          generateTundra ? DyingForest.TEMPERATURE_TUNDRA :
      DyingMixedForest.TEMPERATURE, DyingMixedForest.HUMIDITY,
                          point.continentalness(),
                          point.erosion(),
                          Climate.Parameter.point(0F),
                          point.weirdness(),
      ...
      DyingMixedForest.TEMPERATURE, DyingMixedForest.HUMIDITY,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateFlowerField) {
			BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.FLOWER_FIELD,
				anyOf(allOf(
					CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
						-0.200F, -0.075F),
					CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
						-1.0F, -0.35F))));
			BiomePlacement.addSubOverworld(Biomes.MEADOW, WWBiomes.FLOWER_FIELD,
				anyOf(allOf(
					CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
						-0.200F, -0.075F),
					CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
			...
			BiomePlacement.addSubOverworld(Biomes.MEADOW, WWBiomes.FLOWER_FIELD,
				anyOf(allOf(
					...
					CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
						-0.3675F, -0.3125F))));
      /*for (Climate.ParameterPoint point :
      OverworldBiomeBuilderParameters.points(Biomes.FLOWER_FOREST)) {
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateMixedForest) {
			BiomePlacement.addSubOverworld(Biomes.TAIGA, WWBiomes.MIXED_FOREST,
				anyOf(allOf(
					CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
						-0.45F, -0.140F),
					CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
						0.050F, 0.150F))));
      /*for (Climate.ParameterPoint point :
      OverworldBiomeBuilderParameters.points(Biomes.TAIGA)) {
      ...
      /*			for (Climate.ParameterPoint point :
         OverworldBiomeBuilderParameters.points(Biomes.MANGROVE_SWAMP)) {
			...
			BiomePlacement.addSubOverworld(Biomes.DESERT, WWBiomes.OASIS,
				anyOf((allOf(CriterionBuilder.neighbor(BiomeTags.IS_RIVER),
					CriterionBuilder.value(
						BiomeParameterTargets.PEAKS_VALLEYS, -1.0F,
						0.2F),
					CriterionBuilder.value(
						BiomeParameterTargets.HUMIDITY, 0.1F, 0.3F)))));
			BiomePlacement.addSubOverworld(Biomes.DESERT, WWBiomes.OASIS,
				anyOf((allOf(
					anyOf(CriterionBuilder.neighbor(Biomes.JUNGLE),
						CriterionBuilder.neighbor(Biomes.BAMBOO_JUNGLE),
						CriterionBuilder.neighbor(Biomes.SPARSE_JUNGLE)),
					CriterionBuilder.value(
						BiomeParameterTargets.HUMIDITY, 0.1F, 0.3F)))));
			BiomePlacement.addSubOverworld(Biomes.DESERT, WWBiomes.OASIS,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateOldGrowthDarkForest) {
			BiomePlacement.replaceOverworld(
				Biomes.DARK_FOREST, WWBiomes.OLD_GROWTH_DARK_FOREST, 0.5);
			BiomePlacement.addSubOverworld(Biomes.DARK_FOREST,
				WWBiomes.OLD_GROWTH_DARK_FOREST, CriterionBuilder.NEAR_BORDER);
			BiomePlacement.addSubOverworld(WWBiomes.OLD_GROWTH_DARK_FOREST,
				Biomes.DARK_FOREST,
				anyOf(allOf(CriterionBuilder.value(
					BiomeParameterTargets.TEMPERATURE, -1, -0.2F))));
			BiomePlacement.addSubOverworld(WWBiomes.OLD_GROWTH_DARK_FOREST,
				Biomes.DARK_FOREST,
				anyOf(allOf(CriterionBuilder.value(
					BiomeParameterTargets.TEMPERATURE, 0.2F, 1F))));
			BiomePlacement.addSubOverworld(WWBiomes.OLD_GROWTH_DARK_FOREST,
				Biomes.DARK_FOREST,
				anyOf(allOf(CriterionBuilder.value(
					BiomeParameterTargets.HUMIDITY, -1F, 0.35F))));
			BiomePlacement.addSubOverworld(WWBiomes.OLD_GROWTH_DARK_FOREST,
				Biomes.DARK_FOREST,
				anyOf(allOf(CriterionBuilder.value(
					BiomeParameterTargets.HUMIDITY, -1F, 0.35F))));
      /*for (Climate.ParameterPoint point :
      OverworldBiomeBuilderParameters.points(Biomes.DARK_FOREST)) {
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateSnowyDyingForest) {
			if (WWWorldgenConfig.get().biomeGeneration.generateTundra) {
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS,
					WWBiomes.SNOWY_DYING_FOREST,
					anyOf(allOf(CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.505F,
							-0.495F),
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							-0.105F, 0.050F))));
			} else {
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS,
					WWBiomes.SNOWY_DYING_FOREST,
					anyOf(allOf(CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -0.485F,
							-0.465F),
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							-0.105F, 0.050F))));
			}
      ...
      generateTundra = WWWorldgenConfig.get().biomeGeneration.generateTundra;
          BiomePlacement.addOverworld(WWBiomes.SNOWY_DYING_FOREST,
                  new Climate.ParameterPoint(
                          generateTundra ? SnowyDyingForest.TEMPERATURE_TUNDRA :
      SnowyDyingForest.TEMPERATURE, SnowyDyingForest.HUMIDITY,
                          point.continentalness(),
                          point.erosion(),
                          Climate.Parameter.point(0F),
                          point.weirdness(),
      ...
      SnowyDyingForest.TEMPERATURE, SnowyDyingForest.HUMIDITY,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateSnowyDyingMixedForest) {
			for (Climate.ParameterPoint point :
				OverworldBiomeBuilderParameters.points(Biomes.SNOWY_TAIGA)) {
				boolean weird = FrozenBiomeParameters.isWeird(point);
				if (WWWorldgenConfig.get().biomeGeneration.generateTundra) {
					if (weird) {
						BiomePlacement.addSubOverworld(Biomes.SNOWY_TAIGA,
							WWBiomes.SNOWY_DYING_MIXED_FOREST,
							anyOf(allOf(CriterionBuilder.value(
									BiomeParameterTargets.TEMPERATURE,
									-0.505F, -0.495F),
								CriterionBuilder.value(
									BiomeParameterTargets.HUMIDITY, -0.105F,
									0.155F))));
						BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS,
							WWBiomes.SNOWY_DYING_MIXED_FOREST,
							anyOf(allOf(CriterionBuilder.value(
						...
						BiomePlacement.addSubOverworld(Biomes.SNOWY_TAIGA,
							...
							anyOf(allOf(CriterionBuilder.value(
									...
									-0.505F, -0.495F),
								CriterionBuilder.value(
									BiomeParameterTargets.HUMIDITY, 0.050F,
									0.155F))));
						BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS,
							WWBiomes.SNOWY_DYING_MIXED_FOREST,
							anyOf(allOf(CriterionBuilder.value(
      ...
      generateTundra = WWWorldgenConfig.get().biomeGeneration.generateTundra;
          ...
          BiomePlacement.addOverworld(WWBiomes.SNOWY_DYING_MIXED_FOREST,
                  new Climate.ParameterPoint(
                          generateTundra ?
      SnowyDyingMixedForest.TEMPERATURE_TUNDRA :
      SnowyDyingMixedForest.TEMPERATURE, weird ?
      SnowyDyingMixedForest.HUMIDITY_WEIRD : SnowyDyingMixedForest.HUMIDITY,
                          point.continentalness(),
                          point.erosion(),
                          Climate.Parameter.point(0F),
                          point.weirdness(),
      ...
      /*			for (Climate.ParameterPoint point :
         OverworldBiomeBuilderParameters.points(Biomes.SNOWY_TAIGA)) {
			...
			BiomePlacement.addSubOverworld(Biomes.TAIGA,
				...
				allOf(CriterionBuilder.value(
						BiomeParameterTargets.TEMPERATURE, -1F, -0.45F),
					CriterionBuilder.value(
						BiomeParameterTargets.HUMIDITY, 0.3F, 1F)));
		}
			...
			BiomePlacement.addSubOverworld(Biomes.TAIGA,
				...
				anyOf(allOf(
					CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE,
						-0.250F, -0.050F),
					CriterionBuilder.value(
						BiomeParameterTargets.HUMIDITY, 0.250F, 1.0F),
					CriterionBuilder.value(
						BiomeParameterTargets.EROSION, -1F, 0.05F))));
			...
			if (!WWWorldgenConfig.get().biomeGeneration.generateMapleForest) {
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA,
					anyOf(allOf(CriterionBuilder.value(
							...
							-0.295F),
						CriterionBuilder.value(
							BiomeParameterTargets.HUMIDITY, -1F, -0.2F),
						CriterionBuilder.value(
							BiomeParameterTargets.CONTINENTALNESS, -0.110F,
							0.030F),
						CriterionBuilder.value(BiomeParameterTargets.EROSION,
							-2.233F, 0.450F))));
				...
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA,
					anyOf(allOf(CriterionBuilder.value(
							BiomeParameterTargets.TEMPERATURE, -1.000F,
							-0.450F),
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							0.300F, 0.700F),
						CriterionBuilder.value(
				...
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA,
					anyOf(allOf(CriterionBuilder.value(
						...
						CriterionBuilder.value(BiomeParameterTargets.HUMIDITY,
							-1.0F, -0.100F),
						CriterionBuilder.value(
							BiomeParameterTargets.CONTINENTALNESS, 0.030F,
							0.800F),
						CriterionBuilder.value(BiomeParameterTargets.EROSION,
							-0.375F, 0.450F))));
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS, WWBiomes.TUNDRA,
      ...
      /*List<Climate.ParameterPoint> swampJungleBorders =
      FrozenBiomeParameters.findBorderParameters(
      ...
      swampJungleBorders.forEach(parameterPoint -> {
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateFrozenCaves) {
			for (float depth : FrozenCaves.DEPTHS) {
				BiomePlacement.addOverworld(WWBiomes.FROZEN_CAVES,
					new Climate.ParameterPoint(FrozenCaves.TEMPERATURE,
						FrozenCaves.HUMIDITY, FrozenCaves.CONTINENTALNESS,
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateMagmaticCaves) {
			BiomePlacement.addOverworld(WWBiomes.MAGMATIC_CAVES,
				new Climate.ParameterPoint(MagmaticCaves.TEMPERATURE,
					MagmaticCaves.HUMIDITY, MagmaticCaves.CONTINENTALNESS,
					MagmaticCaves.EROSION, Climate.Parameter.point(1.1F),
					MagmaticCaves.WEIRDNESS, 0L));
		}
		if (WWWorldgenConfig.get().biomeGeneration.generateMapleForest) {
			BiomePlacement.addOverworld(WWBiomes.MAPLE_FOREST,
				new Climate.ParameterPoint(MapleForest.TEMPERATURE,
					MapleForest.HUMIDITY, MapleForest.CONTINENTALNESS,
					MapleForest.EROSION, Climate.Parameter.point(0F),
					MapleForest.WEIRDNESS_A, 0L));
			BiomePlacement.addOverworld(WWBiomes.MAPLE_FOREST,
				new Climate.ParameterPoint(MapleForest.TEMPERATURE,
					MapleForest.HUMIDITY, MapleForest.CONTINENTALNESS,
					MapleForest.EROSION, Climate.Parameter.point(1F),
					MapleForest.WEIRDNESS_A, 0L));
			BiomePlacement.addOverworld(WWBiomes.MAPLE_FOREST,
				new Climate.ParameterPoint(MapleForest.TEMPERATURE,
					MapleForest.HUMIDITY, MapleForest.CONTINENTALNESS,
					MapleForest.EROSION, Climate.Parameter.point(0F),
					MapleForest.WEIRDNESS_B, 0L));
			BiomePlacement.addOverworld(WWBiomes.MAPLE_FOREST,
				new Climate.ParameterPoint(MapleForest.TEMPERATURE,
					MapleForest.HUMIDITY, MapleForest.CONTINENTALNESS,
					MapleForest.EROSION, Climate.Parameter.point(1F),
		...
		if (WWWorldgenConfig.get().biomeGeneration.generateMesogleaCaves) {
			BiomePlacement.addOverworld(WWBiomes.MESOGLEA_CAVES,
				new Climate.ParameterPoint(MesogleaCaves.TEMPERATURE,
					MesogleaCaves.HUMIDITY, MesogleaCaves.CONTINENTALNESS,
					MesogleaCaves.EROSION, Climate.Parameter.span(0.4F, 1F),
