...
public class WilderStructureProcessors {
    ...
    public static final Holder<StructureProcessorList>
            ABANDONED_CABIN_PROCESSOR = registerProcessorList(
            "abandoned_cabin",
            ImmutableList.of(
                    new RuleProcessor(
                            ImmutableList.of(
                                    ...
                                    new ProcessorRule(new RandomBlockMatchTest(
                                            Blocks.SOUL_LANTERN, 0.05F),
                                            AlwaysTrueTest.INSTANCE,
    ...
    private static Holder<StructureProcessorList> registerProcessorList(
        ...
        StructureProcessorList structureProcessorList =
                new StructureProcessorList(processorList);
        return BuiltinRegistries.register(BuiltinRegistries.PROCESSOR_LIST,
                identifier, structureProcessorList);
    }
