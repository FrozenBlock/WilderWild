...
public class TemperateRainforest extends FrozenBiome {
	...
	public void addFeatures(@NotNull BiomeGenerationSettings.Builder features) {
		...
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WilderPlacedFeatures.TEMPERATE_RAINFOREST_TREES.getKey());
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WilderPlacedFeatures.FLOWER_TEMPERATE_RAINFOREST_VANILLA.getKey());
	...
	public void addSpawns(MobSpawnSettings.Builder spawns) {
		...
		spawns.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.WOLF, 3, 4, 4));
	}
