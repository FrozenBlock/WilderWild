...
public class UpwardsPillarConfig implements FeatureConfiguration {
    public static final Codec<UpwardsPillarConfig> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
            ...
            ).apply(instance, UpwardsPillarConfig::new));
    ...
    public UpwardsPillarConfig(BlockState columnBlock, IntProvider height, HolderSet<Block> replaceable) {
