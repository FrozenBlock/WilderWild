...
public record NematocystFeatureConfig(BlockStateProvider stateProvider,
                                      int tries, int xzSpread,
                                      int ySpread)
        implements FeatureConfiguration {

    public static final Codec<NematocystFeatureConfig> CODEC =
            RecordCodecBuilder.create((instance) ->
                    instance.group(
                                    BlockStateProvider.CODEC.fieldOf("stateProvider")
                                            .forGetter(
