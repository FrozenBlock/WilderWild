...
public class WilderFeatureBootstrap {
	...
	public static void bootstrapConfigured(BootstapContext<ConfiguredFeature<?, ?>> entries) {
		...
		var birch = register(entries, WilderTreeConfigured.BIRCH, Feature.TREE, WilderTreeConfigured.birch().dirt(BlockStateProvider.simple(Blocks.DIRT)).decorators(ImmutableList.of(WilderTreeConfigured.SHELF_FUNGUS_007)).build());
		...
		var dyingShortBirch = register(entries, WilderTreeConfigured.DYING_SHORT_BIRCH, Feature.TREE, WilderTreeConfigured.shortBirch().decorators(ImmutableList.of(WilderTreeConfigured.SHELF_FUNGUS_006, WilderTreeConfigured.VINES_1_UNDER_260_03)).ignoreVines().build());
		...
		var fallenSpruceTree = register(entries, WilderTreeConfigured.FALLEN_SPRUCE_TREE, Feature.TREE, WilderTreeConfigured.fallenSpruce().decorators(List.of(WilderTreeConfigured.VINES_1_UNDER_260_075)).dirt(BlockStateProvider.simple(Blocks.DIRT)).build());
		...
		var sandPath = register(entries, WilderMiscConfigured.SAND_PATH, FrozenFeatures.NOISE_PATH_FEATURE, new PathFeatureConfig(BlockStateProvider.simple(Blocks.SAND), 11, 3, 0.12, -0.2, 0.3, false, false, false, false, HolderSet.direct(Blocks.DIRT.builtInRegistryHolder(), Blocks.GRASS_BLOCK.builtInRegistryHolder())));
