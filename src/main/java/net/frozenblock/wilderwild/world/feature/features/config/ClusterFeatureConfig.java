...
public class ClusterFeatureConfig implements FeatureConfiguration {
    public static final Codec<ClusterFeatureConfig> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                            Registry.BLOCK
                                    ...
                                    .orElse((AmethystClusterBlock) Blocks.AMETHYST_CLUSTER)
    ...
    public final AmethystClusterBlock placeBlock;
    ...
    private static DataResult<AmethystClusterBlock> apply(Block block) {
        return block instanceof AmethystClusterBlock clusterBlock
