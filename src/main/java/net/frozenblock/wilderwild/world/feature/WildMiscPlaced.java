...
public class WildMiscPlaced {
    ...
    public static final RegistryEntry<PlacedFeature> DISK_COARSE_DIRT;

    public WildMiscPlaced() {
    }
    static {
        DISK_COARSE_DIRT = PlacedFeatures.register("disk_coarse_dirt", WildMiscConfigured.DISK_COARSE_DIRT, new PlacementModifier[]{RarityFilterPlacementModifier.of(4), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, RandomOffsetPlacementModifier.vertically(ConstantIntProvider.create(-1)), BlockFilterPlacementModifier.of(BlockPredicate.matchingBlocks(new Block[]{Blocks.GRASS_BLOCK})), BiomePlacementModifier.of()});
