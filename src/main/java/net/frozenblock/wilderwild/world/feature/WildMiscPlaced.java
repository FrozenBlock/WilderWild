...
public class WildMiscPlaced {
    ...
    static {
        ...
        COARSE_PATH = PlacedFeatures.register("coarse_path", WildMiscConfigured.COARSE_PATH, RarityFilterPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
    }
}
