...
public class WildTreeConfigured {
    ...
    //CYPRESS
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> CYPRESS = WildConfiguredFeatures.register("cypress", Feature.TREE, (new TreeFeatureConfig.Builder(BlockStateProvider.of(RegisterBlocks.BAOBAB_LOG), new StraightTrunkPlacer(6, 4, 3), BlockStateProvider.of(Blocks.SPRUCE_LEAVES), new SpruceFoliagePlacer(ConstantIntProvider.create(1), UniformIntProvider.create(4, 5), UniformIntProvider.create(4, 6)), new TwoLayersFeatureSize(2, 1, 2))).ignoreVines().build());
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> FUNGUS_CYPRESS = WildConfiguredFeatures.register("fungus_cypress", Feature.TREE, (new TreeFeatureConfig.Builder(BlockStateProvider.of(RegisterBlocks.BAOBAB_LOG), new StraightTrunkPlacer(8, 4, 3), BlockStateProvider.of(Blocks.SPRUCE_LEAVES), new SpruceFoliagePlacer(ConstantIntProvider.create(1), UniformIntProvider.create(4, 6), UniformIntProvider.create(6, 8)), new TwoLayersFeatureSize(2, 1, 2))).decorators(ImmutableList.of(SHELF_FUNGUS_007_ONLY_BROWN)).ignoreVines().build());
