...
public class WildTreeConfigured {
    ...
    static {
        ...
        //BIRCH
        NEW_BIRCH_TREE = WildConfiguredFeatures.register("new_birch_tree", Feature.TREE, new_birch().dirtProvider(BlockStateProvider.of(Blocks.DIRT)).decorators(ImmutableList.of(SHELF_FUNGUS_008)).build());
        NEW_BIRCH_BEES_0004 = WildConfiguredFeatures.register("new_birch_bees_0002", Feature.TREE, new_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_008)).ignoreVines().build());
        NEW_SHORT_BIRCH_BEES_0004 = WildConfiguredFeatures.register("new_short_birch_bees_0004", Feature.TREE, new_short_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build());
        NEW_SUPER_BIRCH_BEES_0004 = WildConfiguredFeatures.register("new_super_birch_bees_0004", Feature.TREE, new_superBirch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_008)).build());
        NEW_FALLEN_BIRCH_TREE = WildConfiguredFeatures.register("new_fallen_birch_tree", Feature.TREE, fallen_birch().dirtProvider(BlockStateProvider.of(Blocks.DIRT)).build());
        SHORT_BIRCH = WildConfiguredFeatures.register("short_birch", Feature.TREE, new_short_birch().decorators(ImmutableList.of(SHELF_FUNGUS_007)).ignoreVines().build());
        NEW_SUPER_BIRCH_BEES = WildConfiguredFeatures.register("new_super_birch_bees", Feature.TREE, new_superBirch().decorators(ImmutableList.of(NEW_BEES)).build());
        //OAK
        NEW_OAK = WildConfiguredFeatures.register("new_oak", Feature.TREE, new_oak().build());
        NEW_OAK_BEES_0004 = WildConfiguredFeatures.register("new_oak_bees_0004", Feature.TREE, new_oak().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build());
        NEW_FANCY_OAK = WildConfiguredFeatures.register("new_fancy_oak", Feature.TREE, new_fancyOak().build());
        NEW_FANCY_OAK_BEES_0004 = WildConfiguredFeatures.register("new_fancy_oak_bees_0004", Feature.TREE, new_fancyOak().decorators(List.of(NEW_BEES_0004)).build());
        NEW_FALLEN_OAK_TREE = WildConfiguredFeatures.register("new_fallen_oak_tree", Feature.TREE, fallen_oak().dirtProvider(BlockStateProvider.of(Blocks.DIRT)).build());
        NEW_FANCY_OAK_BEES = WildConfiguredFeatures.register("new_fancy_oak_bees", Feature.TREE, new_fancyOak().decorators(List.of(NEW_BEES)).build());
        //DARK OAK
        NEW_TALL_DARK_OAK = WildConfiguredFeatures.register("new_tall_dark_oak", Feature.TREE, new_tall_dark_oak().ignoreVines().build());
        //SWAMP TREE
        NEW_SWAMP_TREE = WildConfiguredFeatures.register("new_swamp_tree", Feature.TREE, (new TreeFeatureConfig.Builder(BlockStateProvider.of(Blocks.MANGROVE_LOG),
