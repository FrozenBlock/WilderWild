...
public final class WilderTreeConfigured {
	...
	public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContext) {
		...
		register(bootstapContext, BIRCH, Feature.TREE, new_birch().dirt(BlockStateProvider.simple(Blocks.DIRT)).decorators(ImmutableList.of(SHELF_FUNGUS_007)).build());
		register(bootstapContext, BIRCH_BEES_0004, Feature.TREE, new_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build());
		register(bootstapContext, DYING_BIRCH, Feature.TREE, new_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build());
		register(bootstapContext, SHORT_BIRCH_BEES_0004, Feature.TREE, new_short_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_006)).ignoreVines().build());
		register(bootstapContext, SUPER_BIRCH_BEES_0004, Feature.TREE, new_superBirch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).build());
		register(bootstapContext, DYING_SUPER_BIRCH, Feature.TREE, new_superBirch().decorators(ImmutableList.of(VINES_1_UNDER_260_05, SHELF_FUNGUS_007)).build());
		register(bootstapContext, FALLEN_BIRCH_TREE, Feature.TREE, fallen_birch().decorators(List.of(VINES_08_UNDER_260_075)).dirt(BlockStateProvider.simple(Blocks.DIRT)).build());
		register(bootstapContext, SHORT_BIRCH, Feature.TREE, new_short_birch().decorators(ImmutableList.of(SHELF_FUNGUS_006)).ignoreVines().build());
		register(bootstapContext, SHORT_DYING_BIRCH, Feature.TREE, new_short_birch().decorators(ImmutableList.of(SHELF_FUNGUS_006, VINES_1_UNDER_260_03)).ignoreVines().build());
		register(bootstapContext, SUPER_BIRCH_BEES, Feature.TREE, new_superBirch().decorators(ImmutableList.of(NEW_BEES)).build());
		register(bootstapContext, OAK, Feature.TREE, new_oak().build());
		register(bootstapContext, SHORT_OAK, Feature.TREE, short_oak().build());
		register(bootstapContext, OAK_BEES_0004, Feature.TREE, new_oak().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_006)).ignoreVines().build());
		register(bootstapContext, DYING_OAK, Feature.TREE, new_oak().decorators(ImmutableList.of(VINES_1_UNDER_260_03, SHELF_FUNGUS_006)).ignoreVines().build());
		register(bootstapContext, FANCY_OAK, Feature.TREE, new_fancyOak().build());
		register(bootstapContext, FANCY_DYING_OAK, Feature.TREE, new_fancyOak().decorators(List.of(VINES_1_UNDER_260_05)).build());
		register(bootstapContext, FANCY_DYING_OAK_BEES_0004, Feature.TREE, new_fancyOak().decorators(List.of(NEW_BEES_0004, VINES_1_UNDER_260_05)).build());
		register(bootstapContext, FANCY_OAK_BEES_0004, Feature.TREE, new_fancyOak().decorators(List.of(NEW_BEES_0004)).build());
		register(bootstapContext, FALLEN_OAK_TREE, Feature.TREE, fallen_oak().decorators(List.of(VINES_08_UNDER_260_075)).dirt(BlockStateProvider.simple(Blocks.DIRT)).build());
		register(bootstapContext, FANCY_OAK_BEES, Feature.TREE, new_fancyOak().decorators(List.of(NEW_BEES)).build());
		register(bootstapContext, DYING_DARK_OAK, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.DARK_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.DARK_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()))).decorators(List.of(VINES_1_UNDER_260_05)).ignoreVines().build());
		register(bootstapContext, TALL_DARK_OAK, Feature.TREE, new_tall_dark_oak().ignoreVines().build());
		register(bootstapContext, DYING_TALL_DARK_OAK, Feature.TREE, new_tall_dark_oak().decorators(List.of(VINES_1_UNDER_260_05)).ignoreVines().build());
		register(bootstapContext, SWAMP_TREE, Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new StraightTrunkPlacer(5, 2, 1), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new BlobFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), 3), Optional.of(new MangroveRootPlacer(UniformInt.of(1, 1), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.45F)), new MangroveRootPlacement(Registry.BLOCK.getOrCreateTag(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2F))), new TwoLayersFeatureSize(2, 0, 2))).decorators(List.of(new LeaveVineDecorator(0.125F), new AttachedToLeavesDecorator(0.12F, 1, 0, new RandomizedIntStateProvider(BlockStateProvider.simple(Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)))).ignoreVines().dirt(BlockStateProvider.simple(Blocks.MANGROVE_ROOTS)).build());
