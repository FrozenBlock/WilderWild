...
public final class WilderTreeConfigured {
	...
	public static void registerTreeConfigured(FabricWorldgenProvider.Entries entries) {
		...
		entries.add(key("new_birch_tree"), new ConfiguredFeature<>(Feature.TREE, new_birch().dirt(BlockStateProvider.simple(Blocks.DIRT)).decorators(ImmutableList.of(SHELF_FUNGUS_007)).build()));
    	entries.add(key("new_birch_bees_004"), new ConfiguredFeature<>(Feature.TREE, new_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build()));
		entries.add(key("dying_birch"), treeFeature(new_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).ignoreVines().build()));
		entries.add(key("new_short_birch_bees_0004"), treeFeature(new_short_birch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_006)).ignoreVines().build()));
		entries.add(key("new_super_birch_bees_0004"), treeFeature(new_superBirch().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_007)).build()));
		entries.add(key("dying_super_birch"), treeFeature(new_superBirch().decorators(ImmutableList.of(VINES_1_UNDER_260_05, SHELF_FUNGUS_007)).build()));
		entries.add(key("new_fallen_birch_tree"), treeFeature(fallen_birch().decorators(List.of(VINES_08_UNDER_260_075)).dirt(BlockStateProvider.simple(Blocks.DIRT)).build()));
		entries.add(key("short_birch"), treeFeature(new_short_birch().decorators(ImmutableList.of(SHELF_FUNGUS_006)).ignoreVines().build()));
		entries.add(key("short_dying_birch"), treeFeature(new_short_birch().decorators(ImmutableList.of(SHELF_FUNGUS_006, VINES_1_UNDER_260_03)).ignoreVines().build()));
		entries.add(key("new_super_birch_bees"), treeFeature(new_superBirch().decorators(ImmutableList.of(NEW_BEES)).build()));
		//OAK
		entries.add(key("new_oak"), treeFeature(new_oak().build()));
		entries.add(key("short_oak"), treeFeature(short_oak().build()));
		entries.add(key("new_oak_bees_0004"), treeFeature(new_oak().decorators(ImmutableList.of(NEW_BEES_0004, SHELF_FUNGUS_006)).ignoreVines().build()));
		entries.add(key("dying_oak"), treeFeature(new_oak().decorators(ImmutableList.of(VINES_1_UNDER_260_03, SHELF_FUNGUS_006)).ignoreVines().build()));
		entries.add(key("new_fancy_oak"), treeFeature(new_fancyOak().build()));
		entries.add(key("fancy_dying_oak"), treeFeature(new_fancyOak().decorators(List.of(VINES_1_UNDER_260_05)).build()));
		entries.add(key("fancy_dying_oak_bees_0004"), treeFeature(new_fancyOak().decorators(List.of(NEW_BEES_0004, VINES_1_UNDER_260_05)).build()));
		entries.add(key("new_fancy_oak_bees_0004"), treeFeature(new_fancyOak().decorators(List.of(NEW_BEES_0004)).build()));
		entries.add(key("new_fallen_oak_tree"), treeFeature(fallen_oak().decorators(List.of(VINES_08_UNDER_260_075)).dirt(BlockStateProvider.simple(Blocks.DIRT)).build()));
		entries.add(key("new_fancy_oak_bees"), treeFeature(new_fancyOak().decorators(List.of(NEW_BEES)).build()));
		//DARK OAK
		entries.add(key("dying_dark_oak"), treeFeature(new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.DARK_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.DARK_OAK_LEAVES),
		...
		entries.add(key("new_tall_dark_oak"), treeFeature(new_tall_dark_oak().ignoreVines().build()));
		entries.add(key("dying_tall_dark_oak"), treeFeature(new_tall_dark_oak().decorators(List.of(VINES_1_UNDER_260_05)).ignoreVines().build()));
		//SWAMP
		entries.add(key("new_swamp_tree"), treeFeature(new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG),
	...
	private static ResourceKey<ConfiguredFeature<?, ?>> key(String path) {
		return FrozenConfiguredFeatureUtils.createKey(WilderSharedConstants.MOD_ID, path);
	}

	private static <FC extends FeatureConfiguration, F extends Feature<FC>> ConfiguredFeature<FC, F> treeFeature(FeatureConfiguration fc) {
		return new ConfiguredFeature<FC, F>((F) Feature.TREE, (FC) fc);
	}
}
