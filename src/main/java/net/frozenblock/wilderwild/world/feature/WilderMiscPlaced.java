...
public class WilderMiscPlaced {
    ...
    public static final Holder<PlacedFeature> SANDY_DIRT_PATH = WilderPlacedFeatures.register("sandy_dirt_path", WilderMiscConfigured.SANDY_DIRT_PATH, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
