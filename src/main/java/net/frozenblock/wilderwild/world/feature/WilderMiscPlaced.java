...
public class WilderMiscPlaced {
    ...
    public static final RegistryEntry<PlacedFeature> SANDY_DIRT_PATH = WilderPlacedFeatures.register("sandy_dirt_path", WilderMiscConfigured.SANDY_DIRT_PATH, RarityFilterPlacementModifier.of(6), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
