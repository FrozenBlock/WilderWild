...
public final class WilderMiscConfigured {
    ...
    public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> DISK_MESOGLEA = WilderConfiguredFeatures.register("disk_mesoglea", Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(RegisterBlocks.MESOGLEA), BlockPredicate.matchesBlocks(List.of(Blocks.CLAY, Blocks.STONE, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.DRIPSTONE_BLOCK, Blocks.CALCITE, Blocks.TUFF, Blocks.DEEPSLATE)), UniformInt.of(2, 4), 1));
