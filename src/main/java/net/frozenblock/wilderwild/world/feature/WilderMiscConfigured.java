...
public final class WilderMiscConfigured {
    ...
    public static final FrozenConfiguredFeature<DiskConfiguration, ?> DISK_COARSE_DIRT =
			feature(
					...
					new DiskConfiguration(
							...
							BlockPredicate.matchesBlocks(List.of(Blocks.GRASS_BLOCK, Blocks.COARSE_DIRT)),
							UniformInt.of(6, 8), 1)
			);
    public static final FrozenConfiguredFeature<DiskConfiguration, ?> DISK_MUD =
			feature(
					"disk_mud",
					Feature.DISK,
					new DiskConfiguration(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> MUD_PATH =
			feature(
					"mud_path",
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> COARSE_PATH =
			feature("coarse_dirt_path",
					WilderWild.NOISE_PATH_FEATURE,
					new PathFeatureConfig(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> MOSS_PATH =
			feature(
					"moss_path",
					WilderWild.NOISE_PATH_FEATURE,
					new PathFeatureConfig(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> SAND_PATH =
			feature(
					"sand_path",
					WilderWild.NOISE_PATH_FEATURE,
					new PathFeatureConfig(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> PACKED_MUD_PATH =
			feature(
					"packed_mud_path",
					WilderWild.NOISE_PATH_FEATURE,
					new PathFeatureConfig(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> UNDER_WATER_SAND_PATH =
			feature(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> UNDER_WATER_GRAVEL_PATH =
			feature(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> UNDER_WATER_CLAY_PATH =
			feature(
    ...
    public static final FrozenConfiguredFeature<PathFeatureConfig, ?> UNDER_WATER_CLAY_PATH_BEACH =
			feature(
    ...
    public static final FrozenConfiguredFeature<OreConfiguration, ?> ORE_PACKED_MUD =
			feature(
					"ore_packed_mud",
					Feature.ORE,
    ...
    public static final FrozenConfiguredFeature<OreConfiguration, ?> ORE_CALCITE =
			feature(
					"ore_calcite",
					Feature.ORE,
					new OreConfiguration(
    ...
    public static final FrozenConfiguredFeature<VegetationPatchConfiguration, ?> STONE_POOL =
			feature(
					"stone_pool",
					Feature.WATERLOGGED_VEGETATION_PATCH,
					new VegetationPatchConfiguration(
    ...
    public static final FrozenConfiguredFeature<WilderPillarConfig, ?> UPWARDS_MESOGLEA_PILLAR =
			feature(
					"blue_mesoglea_pillar",
					WilderWild.UPWARDS_PILLAR_FEATURE,
					new WilderPillarConfig(
							RegisterBlocks.MESOGLEA.defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true),
							UniformInt.of(4, 12),
							HolderSet.direct(
    ...
    public static final FrozenConfiguredFeature<WilderPillarConfig, ?> PURPLE_MESOGLEA_PILLAR =
			feature(
					"purple_mesoglea_pillar",
					WilderWild.UPWARDS_PILLAR_FEATURE,
					new WilderPillarConfig(
							RegisterBlocks.PURPLE_MESOGLEA.defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true),
							UniformInt.of(4, 12),
							HolderSet.direct(
									RegisterBlocks.MESOGLEA.builtInRegistryHolder(),
									RegisterBlocks.PURPLE_MESOGLEA.builtInRegistryHolder(),
    ...
    public static final FrozenConfiguredFeature<WilderPillarConfig, ?> DOWNWARDS_MESOGLEA_PILLAR =
			feature(
					"downwards_blue_mesoglea_pillar",
					WilderWild.DOWNWARDS_PILLAR_FEATURE,
					new WilderPillarConfig(
							RegisterBlocks.MESOGLEA.defaultBlockState().setValue(BlockStateProperties.WATERLOGGED, true),
							UniformInt.of(3, 10),
							HolderSet.direct(
    ...
    public static final FrozenConfiguredFeature<WilderPillarConfig, ?> DOWNWARDS_PURPLE_MESOGLEA_PILLAR =
			feature(
