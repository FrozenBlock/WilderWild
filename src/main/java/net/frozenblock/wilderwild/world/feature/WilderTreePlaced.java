...
public class WilderTreePlaced {
    ...
    //BAOBAB
    public static final RegistryEntry<PlacedFeature> BAOBAB = PlacedFeatures.register("baobab", WilderTreeConfigured.BAOBAB, PlacedFeatures.wouldSurvive(RegisterBlocks.BAOBAB_NUT));
    public static final RegistryEntry<PlacedFeature> BAOBAB_TALL = PlacedFeatures.register("baobab_tall", WilderTreeConfigured.BAOBAB_TALL, PlacedFeatures.wouldSurvive(RegisterBlocks.BAOBAB_NUT));
