    ...
    public static void init() {
        if (ClothConfigInteractionHandler.wildGrass()) {
            ...
            BiomeModifications.addFeature(
                    ...
                    WilderPlacedFeatures.NEW_RARE_GRASS_PLACED.unwrapKey()
                            .orElseThrow());
            ...
            BiomeModifications.addFeature(
                    ...
                    GenerationStep.Decoration.VEGETAL_DECORATION,
                    WilderPlacedFeatures.NEW_TALL_GRASS.unwrapKey()
                            .orElseThrow());
            BiomeModifications.addFeature(
                    BiomeSelectors.includeByKey(Biomes.TAIGA),
                    GenerationStep.Decoration.VEGETAL_DECORATION,
                    WilderPlacedFeatures.LARGE_FERN_AND_GRASS_RARE.unwrapKey()
                            .orElseThrow());
            ...
            BiomeModifications.addFeature(
                    ...
                    GenerationStep.Decoration.VEGETAL_DECORATION,
                    WilderPlacedFeatures.LARGE_FERN_AND_GRASS.unwrapKey()
                            .orElseThrow());
