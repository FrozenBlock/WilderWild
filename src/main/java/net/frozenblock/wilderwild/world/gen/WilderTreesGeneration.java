...
public final class WilderTreesGeneration {
    public static void generateTrees() {
        ...
        if (WilderWildConfig.get().worldgen.fallenLogs) {
        ...
        if (WilderWildConfig.get().worldgen.wilderWildTreeGen) {
            ...
            BiomeModifications.addFeature(BiomeSelectors.includeByKey(Biomes.FLOWER_FOREST),
                    GenerationStep.Decoration.VEGETAL_DECORATION, WilderPlacedFeatures.NEW_TREES_FLOWER_FOREST.unwrapKey().orElseThrow());
