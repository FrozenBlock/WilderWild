...
import static net.frozenblock.lib.worldgen.surface.FrozenSurfaceRules.GRAVEL;
import static net.frozenblock.lib.worldgen.surface.FrozenSurfaceRules.SAND;
import static net.frozenblock.lib.worldgen.surface.FrozenSurfaceRules.WATER;

public final class SharedWorldgen {

    public static final class CypressWetlands {
        public static final Climate.Parameter TEMPERATURE =
                Climate.Parameter.span(Temperature.COOL, Temperature.WARM);
        public static final Climate.Parameter HUMIDITY =
                Climate.Parameter.span(Humidity.NEUTRAL, Humidity.HUMID);
        ...
        public static final Climate.Parameter EROSION =
                Climate.Parameter.span(0.50F, 1);
        public static final float OFFSET = 0;
        public static final ArrayList<Climate.Parameter> WEIRDNESS =
                new ArrayList<>() {{
        ...
        public static List<Climate.ParameterPoint> parameters() {
            ImmutableList.Builder<Climate.ParameterPoint> builder =
                    new ImmutableList.Builder<>();
            WEIRDNESS.forEach(weirdness -> {
                builder.add(surfaceParameters(TEMPERATURE, HUMIDITY,
                        CONTINENTALNESS, EROSION, weirdness, OFFSET));
            });
    ...
    public static final class MixedForest {
        public static final Climate.Parameter TEMPERATURE =
                Climate.Parameter.span(Temperature.COOL, Temperature.NEUTRAL);
        public static final Climate.Parameter HUMIDITY = Humidity.FULL_RANGE;
        public static final Climate.Parameter CONTINENTALNESS =
                Climate.Parameter.span(Continentalness.INLAND,
    ...
    public static final class JellyfishCaves {
        ...
        public static final Climate.Parameter HUMIDITY =
                Climate.Parameter.span(Humidity.DRY, Humidity.HUMID);
        public static final Climate.Parameter CONTINENTALNESS =
                Climate.Parameter.span(-1.2F, -0.749F);
        public static final Climate.Parameter EROSION =
                Climate.Parameter.span(Erosion.EROSION_4, Erosion.EROSION_6);
    ...
    public static final class Swamp {
        ...
        public static final Climate.Parameter SWAMP_HUMIDITY =
                Climate.Parameter.span(Climate.Parameter.span(-0.2F, 0.1F),
                        Humidity.HUMID);
        ...
        public static final class MangroveSwamp {
            ...
            public static final Climate.Parameter TEMPERATURE =
                    Climate.Parameter.span(Temperature.NEUTRAL,
                            Temperature.HOT);
        }
    }
    ...
    public static SurfaceRules.RuleSource betaBeachSurfaceRules() {
        var gravel = SurfaceRules.ifTrue(
                SurfaceRules.UNDER_FLOOR, SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                                FrozenSurfaceRules.isBiome(
                                        WilderRegistry.GRAVEL_BEACH_BIOMES),
                                SurfaceRules.ifTrue(
                                        SurfaceRules.yStartCheck(
                                                VerticalAnchor.absolute(58), 0),
                                        SurfaceRules.ifTrue(
                                                SurfaceRules.not(
                                                        SurfaceRules.yStartCheck(
                                                                VerticalAnchor.absolute(
        ...
        var sand = SurfaceRules.sequence(SurfaceRules.ifTrue(
                SurfaceRules.DEEP_UNDER_FLOOR, SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                                FrozenSurfaceRules.isBiome(
                                        WilderRegistry.SAND_BEACH_BIOMES),
                                SurfaceRules.ifTrue(
                                        SurfaceRules.yStartCheck(
                                                VerticalAnchor.absolute(58), 0),
                                        SurfaceRules.ifTrue(
                ...
                SurfaceRules.DEEP_UNDER_FLOOR, SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                                FrozenSurfaceRules.isBiome(
                                        WilderRegistry.OTHER_SAND_BEACH_BIOMES),
                                SurfaceRules.ifTrue(
                                        SurfaceRules.yStartCheck(
                                                VerticalAnchor.absolute(58), 0),
                                        SurfaceRules.ifTrue(
    ...
    public static Climate.ParameterPoint bottomParameters(
        ...
        return Climate.parameters(temperature, humidity, continentalness,
                erosion, Climate.Parameter.point(1.1F), weirdness, offset);
    }
    ...
    public static Climate.ParameterPoint deepParameters(
        ...
        return Climate.parameters(temperature, humidity, continentalness,
                erosion, Climate.Parameter.span(0.65F, 1.1F), weirdness,
                offset);
    }
    ...
    public static Climate.ParameterPoint semiDeepParameters(
        ...
        return Climate.parameters(temperature, humidity, continentalness,
                erosion, Climate.Parameter.span(0.4F, 1), weirdness, offset);
    }
    ...
    public static Climate.ParameterPoint surfaceParameters(
        ...
        return Climate.parameters(temperature, humidity, continentalness,
                erosion, Climate.Parameter.span(0, 1), weirdness, offset);
    }
}
