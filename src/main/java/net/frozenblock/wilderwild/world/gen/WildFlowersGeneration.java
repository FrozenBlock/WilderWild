...
public class WildFlowersGeneration {
    public static void generateFlower() {
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BIRCH_FOREST, BiomeKeys.OLD_GROWTH_BIRCH_FOREST),
                GenerationStep.Feature.VEGETAL_DECORATION, WildPlacedFeatures.GLORY_OF_THE_SNOW.getKey().get());
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.SWAMP, BiomeKeys.MANGROVE_SWAMP, RegisterWorldgen.CYPRESS_WETLANDS, BiomeKeys.STONY_SHORE),
                GenerationStep.Feature.VEGETAL_DECORATION, WildPlacedFeatures.WATER_MOSS.getKey().get());
