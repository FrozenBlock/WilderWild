...
public final class WilderMusic {
    public static void playMusic() {
        ...
        /** MUSIC */
        BiomeModifications.create(WilderWild.id("modify_birch_forest_music"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.BIRCH_FOREST),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setMusic(Musics.createGameMusic(
                                        RegisterSounds.MUSIC_OVERWORLD_WILD_FORESTS)));
        BiomeModifications.create(
                        WilderWild.id("modify_old_birch_forest_music"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.OLD_GROWTH_BIRCH_FOREST),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setMusic(Musics.createGameMusic(
                                        RegisterSounds.MUSIC_OVERWORLD_WILD_FORESTS)));
        BiomeModifications.create(WilderWild.id("modify_flower_forest_music"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
        ...
        BiomeModifications.create(WilderWild.id("modify_deep_dark_ambience"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.DEEP_DARK),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setAmbientSound(
                                        RegisterSounds.AMBIENT_DEEP_DARK_LOOP));
        BiomeModifications.create(WilderWild.id("modify_deep_dark_additions"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.DEEP_DARK),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setAdditionsSound(new AmbientAdditionsSettings(
        ...
        BiomeModifications.create(
                ...
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.DRIPSTONE_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setAmbientSound(
                                        RegisterSounds.AMBIENT_DRIPSTONE_CAVES_LOOP));
        BiomeModifications.create(
                        WilderWild.id("modify_dripstone_caves_additions"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.DRIPSTONE_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
        ...
        BiomeModifications.create(WilderWild.id("modify_lush_caves_ambience"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.LUSH_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setAmbientSound(
                                        RegisterSounds.AMBIENT_LUSH_CAVES_LOOP));
        BiomeModifications.create(WilderWild.id("modify_lush_caves_additions"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(Biomes.LUSH_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
        ...
        BiomeModifications.create(
                ...
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(RegisterWorldgen.JELLYFISH_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
                                .setAmbientSound(
                                        RegisterSounds.AMBIENT_JELLYFISH_CAVES_LOOP));
        BiomeModifications.create(
                        WilderWild.id("modify_jellyfish_caves_additions"))
                .add(ModificationPhase.REPLACEMENTS,
                        (context) -> context.getBiomeKey()
                                .equals(RegisterWorldgen.JELLYFISH_CAVES),
                        (selectionContext, modificationContext) -> modificationContext.getEffects()
