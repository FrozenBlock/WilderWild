	...
	public static SurfaceRules.SequenceRuleSource rawSurfaceRules() {
		...
		list.add(
				SurfaceRules.sequence(
						...
						SurfaceRules.ifTrue(SurfaceRules.waterStartCheck(-6, -1), SurfaceRules.ifTrue(SurfaceRules.isBiome(RegisterWorldgen.OASIS), SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, SANDSTONE)))
				)
		);
