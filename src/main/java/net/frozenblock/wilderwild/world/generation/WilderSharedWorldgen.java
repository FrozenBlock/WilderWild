...
public final class WilderSharedWorldgen {
	...
	public static SurfaceRules.RuleSource oasisRules() {
		...
		SurfaceRules.RuleSource sandStone = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.waterStartCheck(-6, -1), SurfaceRules.ifTrue(SurfaceRules.isBiome(RegisterWorldgen.OASIS), SurfaceRules.ifTrue(SurfaceRules.VERY_DEEP_UNDER_FLOOR, SANDSTONE))));
