...
extends TrunkPlacer {
	...
	protected static <P extends CherryTrunkPlacer> Products.P7<RecordCodecBuilder.Mu<P>, Integer, Integer, Integer, IntProvider, IntProvider, UniformInt, IntProvider> cherryCodec(RecordCodecBuilder.Instance<P> builder) {
    ...
    protected TrunkPlacerType<?> type() {
        return WilderWild.CHERRY_TRUNK_PLACER;
    }
