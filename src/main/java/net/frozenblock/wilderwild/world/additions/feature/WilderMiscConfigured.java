...
public final class WilderMiscConfigured {
	...
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> SCORCHED_SAND_DISK = WilderConfiguredFeatures.register("scorched_sand", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState().setValue(RegisterProperties.CRACKEDNESS, 1)), BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState()), UniformInt.of(2, 8), 0.95F, HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), RegisterBlocks.SCORCHED_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.SAND.builtInRegistryHolder())));
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> SCORCHED_SAND_DISK_LIGHTNING = WilderConfiguredFeatures.register("scorched_sand_lightning", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState().setValue(RegisterProperties.CRACKEDNESS, 1)), BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState()), UniformInt.of(1, 3), 0.85F, HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), RegisterBlocks.SCORCHED_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.SAND.builtInRegistryHolder())));
	// BADLANDS
