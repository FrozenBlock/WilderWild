...
public final class WilderMiscConfigured {
	...
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> DRY_SAND_DISK = WilderConfiguredFeatures.register("dry_sand", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState().setValue(RegisterProperties.CRACKNESS, 1)), BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState()), UniformInt.of(2, 8), 0.95F, HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), RegisterBlocks.DRY_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.SAND.builtInRegistryHolder())));
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> DRY_SAND_DISK_LIGHTNING = WilderConfiguredFeatures.register("dry_sand_lightning", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState().setValue(RegisterProperties.CRACKNESS, 1)), BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState()), UniformInt.of(1, 3), 0.925F, HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), RegisterBlocks.DRY_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.SAND.builtInRegistryHolder())));
	// BADLANDS
