...
public final class WilderMiscConfigured {
	...
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> DRY_SAND_DISK = WilderConfiguredFeatures.register("dry_sand", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState().setValue(RegisterProperties.CRACKNESS, 1)), BlockStateProvider.simple(RegisterBlocks.DRY_SAND.defaultBlockState()), UniformInt.of(4, 12), HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), Blocks.SANDSTONE.builtInRegistryHolder())));
	// BADLANDS
