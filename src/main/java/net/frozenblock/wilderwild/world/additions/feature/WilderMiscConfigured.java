...
public final class WilderMiscConfigured {
	...
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> SCORCHED_SAND_DISK_HUGE = WilderConfiguredFeatures.register("scorched_sand_huge", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState().setValue(RegisterProperties.CRACKEDNESS, 1)), BlockStateProvider.simple(RegisterBlocks.SCORCHED_SAND.defaultBlockState()), UniformInt.of(12, 24), 0.95F, 0.925F, 0.65F, 0.8F, HolderSet.direct(Blocks.SAND.builtInRegistryHolder(), RegisterBlocks.SCORCHED_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.SAND.builtInRegistryHolder())));
	...
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> SCORCHED_RED_SAND_DISK = WilderConfiguredFeatures.register("scorched_red_sand", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.SCORCHED_RED_SAND.defaultBlockState().setValue(RegisterProperties.CRACKEDNESS, 1)), BlockStateProvider.simple(RegisterBlocks.SCORCHED_RED_SAND.defaultBlockState()), UniformInt.of(2, 8), 0.95F, 0.925F, 0.65F, 0.8F, HolderSet.direct(Blocks.RED_SAND.builtInRegistryHolder(), RegisterBlocks.SCORCHED_RED_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.RED_SAND.builtInRegistryHolder())));
	public static final Holder<ConfiguredFeature<FadingDiskFeatureConfig, ?>> SCORCHED_RED_SAND_DISK_HUGE = WilderConfiguredFeatures.register("scorched_red_sand_huge", FrozenFeatures.FADING_DISK_FEATURE, new FadingDiskFeatureConfig(BlockStateProvider.simple(RegisterBlocks.SCORCHED_RED_SAND.defaultBlockState().setValue(RegisterProperties.CRACKEDNESS, 1)), BlockStateProvider.simple(RegisterBlocks.SCORCHED_RED_SAND.defaultBlockState()), UniformInt.of(12, 24), 0.95F, 0.925F, 0.65F, 0.8F, HolderSet.direct(Blocks.RED_SAND.builtInRegistryHolder(), RegisterBlocks.SCORCHED_RED_SAND.builtInRegistryHolder()), HolderSet.direct(Blocks.RED_SAND.builtInRegistryHolder())));
