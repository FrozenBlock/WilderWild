...
public final class WilderTreeConfigured {
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SHORT_FROND_PALM = WilderConfiguredFeatures.register("short_frond_palm", Feature.TREE, palmBuilder(RegisterBlocks.PALM_LOG, RegisterBlocks.PALM_LEAVES, 6, 3, 2, 4)
			.decorators(List.of(new LeavesAroundTopLogDecorator(0.25F, 0, 0, new RandomizedIntStateProvider(BlockStateProvider.simple(RegisterBlocks.COCONUT.defaultBlockState().setValue(BlockStateProperties.HANGING, true)), BaobabNutBlock.AGE, UniformInt.of(0, 2)), 4, List.of(Direction.DOWN)))).build());
