...
public final class WilderTreeConfigured {
	...
	//SWAMP TREE
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SWAMP_TREE = WilderConfiguredFeatures.register("swamp_tree", Feature.TREE, (new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.OAK_LOG),
