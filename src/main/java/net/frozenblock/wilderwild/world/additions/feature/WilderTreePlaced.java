...
public final class WilderTreePlaced {
	...
	public static final Holder<PlacedFeature> MOSSY_FALLEN_BIRCH_CHECKED = PlacementUtils.register("mossy_fallen_birch_checked", WilderTreeConfigured.MOSSY_FALLEN_BIRCH_TREE, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
