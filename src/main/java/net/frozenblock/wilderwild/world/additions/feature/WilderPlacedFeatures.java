...
public final class WilderPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> MOSSY_FALLEN_TREES_MIXED_PLACED = key("mossy_fallen_trees_mixed_placed",
			WilderConfiguredFeatures.MOSSY_FALLEN_TREES_MIXED, CountPlacement.of(2), InSquarePlacement.spread(),
			PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> MOSSY_FALLEN_TREES_OAK_AND_BIRCH_PLACED = key("mossy_fallen_trees_oak_and_birch_placed",
    ...
    //TREES
    public static final ResourceKey<PlacedFeature> TREES_PLAINS = key("trees_plains", WilderConfiguredFeatures.TREES_PLAINS,
	...
	public static final ResourceKey<PlacedFeature> TREES_FLOWER_FIELD = key("trees_flower_field", WilderConfiguredFeatures.TREES_FLOWER_FIELD,
	...
	public static final ResourceKey<PlacedFeature> TREES_SEMI_BIRCH_AND_OAK = key("trees_semi_birch_and_oak",
	...
	public static final ResourceKey<PlacedFeature> TREES_BIRCH = key("trees_birch",
            WilderConfiguredFeatures.TREES_BIRCH, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));

    public static final ResourceKey<PlacedFeature> BIRCH_TALL = key("birch_tall",
	...
	public static final ResourceKey<PlacedFeature> SHORT_MEGA_SPRUCE_PLACED = key("short_mega_spruce_placed",
			WilderConfiguredFeatures.SHORT_MEGA_SPRUCE, treePlacement(RarityFilter.onAverageOnceEvery(9)));

	public static final ResourceKey<PlacedFeature> SHORT_MEGA_SPRUCE_ON_SNOW_PLACED = key("short_mega_spruce_on_snow_placed",
    ...
    public static final ResourceKey<PlacedFeature> TREES_OLD_GROWTH_SPRUCE_TAIGA1 = key("trees_old_growth_spruce_taiga",
            WilderConfiguredFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));

	public static final ResourceKey<PlacedFeature> TREES_OLD_GROWTH_SNOWY_PINE_TAIGA = key("trees_old_growth_snowy_pine_taiga",
	...
	public static final ResourceKey<PlacedFeature> ARID_SAVANNA_TREES = key("arid_savanna_trees",
			WilderConfiguredFeatures.ARID_SAVANNA_TREES, treePlacement(RarityFilter.onAverageOnceEvery(12)));

	public static final ResourceKey<PlacedFeature> WOODED_BADLANDS_TREES = key("wooded_badlands_trees",
			WilderConfiguredFeatures.WOODED_BADLANDS_TREES, treePlacement(PlacementUtils.countExtra(7, 0.1F, 1)));

    public static final ResourceKey<PlacedFeature> TREES_SWAMP = key("trees_swamp", WilderTreeConfigured.SWAMP_TREE,
	...
	public static final ResourceKey<PlacedFeature> TEMPERATE_RAINFOREST_TREES = key("temperate_rainforest_trees",
			WilderConfiguredFeatures.TEMPERATE_RAINFOREST_TREES, treePlacement(PlacementUtils.countExtra(13, 0.1F, 1)));

	public static final ResourceKey<PlacedFeature> RAINFOREST_TREES = key("rainforest_trees",
	...
	public static final ResourceKey<PlacedFeature> OLD_GROWTH_BIRCH_TAIGA_TREES = key("old_growth_birch_taiga_trees",
			WilderConfiguredFeatures.OLD_GROWTH_BIRCH_TAIGA_TREES, treePlacement(CountPlacement.of(3)));

	public static final ResourceKey<PlacedFeature> PARCHED_FOREST_TREES = key("parched_forest_trees",
			WilderConfiguredFeatures.PARCHED_FOREST_TREES, treePlacement(PlacementUtils.countExtra(4, 0.1f, 1)));

	public static final ResourceKey<PlacedFeature> ARID_FOREST_TREES = key("arid_forest_trees",
			WilderConfiguredFeatures.ARID_FOREST_TREES, treePlacement(CountPlacement.of(3)));

	public static final ResourceKey<PlacedFeature> BIRCH_JUNGLE_TREES = key("birch_jungle_trees",
			WilderConfiguredFeatures.BIRCH_JUNGLE_TREES, treePlacement(CountPlacement.of(29)));

	public static final ResourceKey<PlacedFeature> SPARSE_BIRCH_JUNGLE_TREES = key("sparse_birch_jungle_trees",
	...
	public static final ResourceKey<PlacedFeature> RED_MUSHROOM_PLACED = key("red_mushroom_placed",
			VegetationFeatures.PATCH_RED_MUSHROOM, worldSurfaceSquaredWithCount(10));

	public static final ResourceKey<PlacedFeature> DARK_FOREST_MUSHROOM_PLACED = key("dark_forest_mushroom_placed",
	...
	public static final ResourceKey<PlacedFeature> HUGE_BROWN_MUSHROOM_PLACED = key("huge_brown_mushroom_placed",
	...
	public static final ResourceKey<PlacedFeature> RAINFOREST_MUSHROOMS_PLACED = key("rainforest_mushroom_placed",
...
=======
	public static final ResourceKey<PlacedFeature> DEAD_BUSH_PLACED = key("dead_bush_placed",
			VegetationFeatures.PATCH_DEAD_BUSH, CountPlacement.of(10), InSquarePlacement.spread(),
			PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> DEAD_BUSH_AND_BUSH_PLACED = key("dead_bush_and_bush_placed",
			WilderConfiguredFeatures.DEAD_BUSH_AND_BUSH, CountPlacement.of(10), InSquarePlacement.spread(),
			PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> BUSH_AND_DEAD_BUSH_PLACED = key("bush_and_dead_bush_placed",
	...
	public static final ResourceKey<PlacedFeature> BADLANDS_BUSH_RARE_SAND_PLACED = key("badlands_bush_rare_sand_placed",
	...
	public static final ResourceKey<PlacedFeature> WOODED_BADLANDS_BUSH_TERRACOTTA_PLACED = key("wooded_badlands_bush_terracotta_placed",
	...
	public static final ResourceKey<PlacedFeature> FLOWER_FIELD_GRASS_PLACED = key("flower_field_grass_placed",
			VegetationFeatures.PATCH_GRASS_JUNGLE, worldSurfaceSquaredWithCount(15));

	public static final ResourceKey<PlacedFeature> PATCH_TALL_GRASS_FF = key("patch_tall_grass_ff", WilderConfiguredFeatures.LARGE_FERN_AND_GRASS_2, NoiseThresholdCountPlacement.of(-0.8, 0, 7), RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
...
<<<<<<< HEAD
	...
	public static final ResourceKey<PlacedFeature> FLOWER_FLOWER_FIELD = key("flower_flower_field", WilderConfiguredFeatures.FLOWER_FLOWER_FIELD,
	...
	public static final ResourceKey<PlacedFeature> FLOWER_TEMPERATE_RAINFOREST = key("flower_temperate_rainforest", WilderConfiguredFeatures.FLOWERS_TEMPERATE_RAINFOREST,
	...
	public static final ResourceKey<PlacedFeature> FLOWER_RAINFOREST = key("flower_rainforest", WilderConfiguredFeatures.FLOWERS_RAINFOREST,
			CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> MOSS_CARPET = key("moss_carpet", WilderConfiguredFeatures.MOSS_CARPET,
			RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature>  TALL_FLOWER_FIELD_FLOWERS = key("tall_flower_field_flowers", WilderConfiguredFeatures.TALL_FLOWER_FLOWER_FIELD,
	...
	//VEGETATION
    public static final ResourceKey<PlacedFeature> POLLEN_PLACED = key("pollen",
    ...
    public static final ResourceKey<PlacedFeature> PATCH_CATTAIL =
            key("cattail", WilderConfiguredFeatures.CATTAIL,
                    RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> PATCH_CATTAIL_COMMON =
			key("cattail_common", WilderConfiguredFeatures.CATTAIL_06,
					InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

    public static final ResourceKey<PlacedFeature> PATCH_FLOWERED_WATERLILY = key("patch_flowered_waterlily",
            WilderConfiguredFeatures.PATCH_FLOWERED_WATERLILY, worldSurfaceSquaredWithCount(1));

    public static final ResourceKey<PlacedFeature> PATCH_ALGAE =
            key("patch_algae", WilderConfiguredFeatures.PATCH_ALGAE,
                    RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

    public static final ResourceKey<PlacedFeature> PATCH_ALGAE_5 =
            key("patch_algae_5", WilderConfiguredFeatures.PATCH_ALGAE,
                    RarityFilter.onAverageOnceEvery(5), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

    public static final ResourceKey<PlacedFeature> PATCH_BERRY_FOREST =
            key("patch_berry_forest", VegetationFeatures.PATCH_BERRY_BUSH, RarityFilter.onAverageOnceEvery(28), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());

    public static final ResourceKey<PlacedFeature> TERMITE_PLACED = key("termite_placed",
	...
	public static final ResourceKey<PlacedFeature> PRICKLY_PEAR_RARE = key("prickly_pear_rare",
	...
	public static final ResourceKey<PlacedFeature> JELLYFISH_CAVES_BLUE_MESOGLEA = key(
            "blue_mesoglea",
    ...
    public static final ResourceKey<PlacedFeature> JELLYFISH_CAVES_UPSIDE_DOWN_BLUE_MESOGLEA = key(
    ...
    public static final ResourceKey<PlacedFeature> JELLYFISH_CAVES_PURPLE_MESOGLEA = key(
            "purple_mesoglea",
	...
	public static final ResourceKey<PlacedFeature> NEMATOCYST_BLUE = key(
			"nematocyst_blue",
	...
	public static final ResourceKey<PlacedFeature> NEMATOCYST_PURPLE = key(
			"nematocyst_purple",
	...
	public static final ResourceKey<PlacedFeature> MESOGLEA_CLUSTER_PURPLE = key(
	...
	public static final ResourceKey<PlacedFeature> MESOGLEA_CLUSTER_BLUE = key(
	...
	public static final ResourceKey<PlacedFeature> LARGE_MESOGLEA_PURPLE = key(
	...
	public static final ResourceKey<PlacedFeature> LARGE_MESOGLEA_BLUE = key(
			"large_mesoglea_blue",
			WilderConfiguredFeatures.LARGE_MESOGLEA_BLUE,
			CountPlacement.of(UniformInt.of(1, 5)), RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());

	public static final ResourceKey<PlacedFeature> SMALL_SPONGES = key(
			"small_sponges",
	...
	public static final ResourceKey<PlacedFeature> SMALL_SPONGES_RARE = key(
			"small_sponges_rare",
			WilderConfiguredFeatures.SMALL_SPONGE,
