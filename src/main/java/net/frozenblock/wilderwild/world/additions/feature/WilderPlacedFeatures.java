...
public final class WilderPlacedFeatures {
	...
	public static final Holder<PlacedFeature> TREES_OLD_GROWTH_SNOWY_SPRUCE_TAIGA = register("trees_old_growth_snowy_spruce_taiga",
			WilderConfiguredFeatures.TREES_OLD_GROWTH_SNOWY_SPRUCE_TAIGA, treePlacement(PlacementUtils.countExtra(8, 0.1F, 1)));
