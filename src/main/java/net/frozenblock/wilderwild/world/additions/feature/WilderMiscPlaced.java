...
public final class WilderMiscPlaced {
	...
	public static final Holder<PlacedFeature> SCORCHED_SAND = WilderPlacedFeatures.register("scorched_sand", WilderMiscConfigured.SCORCHED_SAND_DISK, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
	public static final Holder<PlacedFeature> SCORCHED_SAND_HUGE = WilderPlacedFeatures.register("scorched_sand_huge", WilderMiscConfigured.SCORCHED_SAND_DISK_HUGE, RarityFilter.onAverageOnceEvery(125), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
	// BADLANDS
	...
	public static final Holder<PlacedFeature> SCORCHED_RED_SAND = WilderPlacedFeatures.register("scorched_red_sand", WilderMiscConfigured.SCORCHED_RED_SAND_DISK, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
	public static final Holder<PlacedFeature> SCORCHED_RED_SAND_HUGE = WilderPlacedFeatures.register("scorched_red_sand_huge", WilderMiscConfigured.SCORCHED_RED_SAND_DISK_HUGE, RarityFilter.onAverageOnceEvery(125), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
