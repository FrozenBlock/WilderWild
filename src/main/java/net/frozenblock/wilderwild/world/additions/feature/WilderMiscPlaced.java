...
public final class WilderMiscPlaced {
	...
	public static final Holder<PlacedFeature> BLUE_MESOGLEA_PATH = WilderPlacedFeatures.register("blue_mesoglea_path", WilderMiscConfigured.BLUE_MESOGLEA_PATH, CountPlacement.of(UniformInt.of(1, 20)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), BiomeFilter.biome());
	public static final Holder<PlacedFeature> PURPLE_MESOGLEA_PATH = WilderPlacedFeatures.register("purple_mesoglea_path", WilderMiscConfigured.PURPLE_MESOGLEA_PATH, CountPlacement.of(UniformInt.of(1, 20)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), EnvironmentScanPlacement.scanningFor(Direction.UP, BlockPredicate.solid(), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, 12), BiomeFilter.biome());
	// OASIS
