...
public final class WilderMiscPlaced {
	...
	public static final Holder<PlacedFeature> GRASS_PATH = WilderPlacedFeatures.register("grass_path", WilderMiscConfigured.GRASS_PATH, RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
