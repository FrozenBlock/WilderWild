...
public final class WilderMiscPlaced {
	...
	public static final Holder<PlacedFeature> DRY_SAND = WilderPlacedFeatures.register("dry_sand", WilderMiscConfigured.DRY_SAND_DISK, RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome());
	// BADLANDS
