...
public final class RegisterEntities {
    ...
    public static final EntityType<JellyCloud> JELLY_CLOUD = Registry.register(Registry.ENTITY_TYPE, WilderWild.id("jelly_cloud"), FabricEntityTypeBuilder.<JellyCloud>create().spawnGroup(MobCategory.MISC).entityFactory(JellyCloud::new).fireImmune().dimensions(EntityDimensions.scalable(0.6F, 0.6F)).trackRangeBlocks(32).trackedUpdateRate(2).build());
