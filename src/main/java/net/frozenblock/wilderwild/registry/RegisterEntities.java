...
public final class RegisterEntities {
    ...
    public static final EntityType<Jellyfish> JELLYFISH = Registry.register(Registry.ENTITY_TYPE, WilderWild.id("jellyfish"), FabricEntityTypeBuilder.createMob().spawnGroup(MobCategory.UNDERGROUND_WATER_CREATURE).entityFactory(Jellyfish::new).defaultAttributes(Jellyfish::addAttributes).dimensions(EntityDimensions.scalable(0.6F, 0.8F)).build());
    ...
    public static void init() {
        ...
        SpawnPlacements.register(JELLYFISH, SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING, Jellyfish::canSpawn);
    }
}