...
public class RegisterEntities {
    ...
    public static final EntityType<FireflyEntity> FIREFLY = Registry.register(Registry.ENTITY_TYPE, new Identifier(WilderWild.MOD_ID, "firefly"), FabricEntityTypeBuilder.createMob().spawnGroup(WilderWild.FIREFLIES).entityFactory(FireflyEntity::new).defaultAttributes(FireflyEntity::addAttributes).dimensions(EntityDimensions.fixed(0.3F, 0.3F)).build());
