...
public class RegisterItems {
    ...
    public static final MusicDiscItem MUSIC_DISC_GOATHORN_SYMPHONY = new MusicDiscItem(15, RegisterSounds.MUSIC_DISC_GOATHORN_SYMPHONY, new FabricItemSettings().group(ItemGroup.MISC).maxCount(1).rarity(Rarity.RARE));
