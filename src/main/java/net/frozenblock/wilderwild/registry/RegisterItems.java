...
public class RegisterItems {
    public static final AncientCityGoatHorn ANCIENT_GOAT_HORN = new AncientCityGoatHorn(new FabricItemSettings().group(ItemGroup.MISC).maxCount(1).rarity(Rarity.EPIC));
    ...
    public static void RegisterItems() {
        Registry.register(Registry.ITEM, new Identifier(WilderWild.MOD_ID, "ancient_goat_horn"), ANCIENT_GOAT_HORN);
