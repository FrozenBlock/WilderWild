...
public class RegisterWorldgen {
    ...
    public static void addCypressWetlandsFeatures(BiomeGenerationSettings.Builder builder) {
        ...
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WilderPlacedFeatures.WHITE_DANDELION_CYPRESS);
    ...
    public static void addMixedForestFeatures(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WilderPlacedFeatures.WHITE_DANDELION_MIXED);
