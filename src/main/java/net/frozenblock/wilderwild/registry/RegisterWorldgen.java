...
public final class RegisterWorldgen implements SurfaceRuleEvents.OverworldModifierCallback {
	...
	public static void addOasisFeatures(BiomeGenerationSettings.Builder builder) {
		...
		builder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, WilderMiscPlaced.MOSS_PATH);
		builder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, WilderPlacedFeatures.OASIS_GRASS_PLACED);
