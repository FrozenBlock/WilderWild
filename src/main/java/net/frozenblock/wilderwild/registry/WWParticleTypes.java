...
public final class WWParticleTypes {
	...
	public static final ParticleType<WindSeedParticleOptions> WIND_SPAWNER = register(
		"wind_spawner", false, particleType -> WindSeedParticleOptions.CODEC, particleType -> WindSeedParticleOptions.STREAM_CODEC
	);
