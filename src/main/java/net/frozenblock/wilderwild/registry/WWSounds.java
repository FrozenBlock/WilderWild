...
public final class WWSounds {
	...
	public static final SoundEvent BLOCK_FROZEN_GRASS_PLACE = register("block.frozen_grass.place");
	public static final SoundEvent BLOCK_FROZEN_GRASS_BREAK = register("block.frozen_grass.break");
	public static final SoundEvent BLOCK_DRY_GRASS_PLACE = register("block.dry_grass.place");
	public static final SoundEvent BLOCK_DRY_GRASS_BREAK = register("block.dry_grass.break");
	public static final SoundEvent BLOCK_BARNACLES_PLACE = register("block.barnacles.place");
	public static final SoundEvent BLOCK_BARNACLES_BREAK = register("block.barnacles.break");
	...
	public static final Holder<SoundEvent> ENTITY_OSTRICH_SADDLE = registerForHolder("entity.ostrich.saddle");
	...
	public static final Holder.Reference<SoundEvent> MUSIC_OVERWORLD_WILD_BADLANDS = registerForHolder("music.overworld.wilder_badlands");
	public static final Holder.Reference<SoundEvent> MUSIC_OVERWORLD_WILD_DESERTS = registerForHolder("music.overworld.wilder_deserts");
	...
	public static final Holder.Reference<SoundEvent> MUSIC_OVERWORLD_WILD_FROZEN_OCEANS = registerForHolder("music.overworld.wilder_frozen_oceans");
