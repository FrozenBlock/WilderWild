...
public final class RegisterParticles {
	...
	public static void registerParticles() {
		...
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("blue_pearlescent_hanging_mesoglea_drip"), BLUE_PEARLESCENT_HANGING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("blue_pearlescent_falling_mesoglea_drip"), BLUE_PEARLESCENT_FALLING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("blue_pearlescent_landing_mesoglea_drip"), BLUE_PEARLESCENT_LANDING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("purple_pearlescent_hanging_mesoglea_drip"), PURPLE_PEARLESCENT_HANGING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("purple_pearlescent_falling_mesoglea_drip"), PURPLE_PEARLESCENT_FALLING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("purple_pearlescent_landing_mesoglea_drip"), PURPLE_PEARLESCENT_LANDING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("pink_hanging_mesoglea_drip"), PINK_HANGING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("pink_falling_mesoglea_drip"), PINK_FALLING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("pink_landing_mesoglea_drip"), PINK_LANDING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("red_hanging_mesoglea_drip"), RED_HANGING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("red_falling_mesoglea_drip"), RED_FALLING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("red_landing_mesoglea_drip"), RED_LANDING_MESOGLEA);
		...
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("blue_falling_mesoglea_drip"), BLUE_FALLING_MESOGLEA);
		Registry.register(Registry.PARTICLE_TYPE, WilderWild.id("blue_landing_mesoglea_drip"), BLUE_LANDING_MESOGLEA);
	}
