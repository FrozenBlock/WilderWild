...
public final class RegisterFood {
	...
	public static final FoodProperties CRAB_CLAW = new FoodProperties.Builder().nutrition(1).saturationMod(0.2F).build();
	public static final FoodProperties COOKED_CRAB_CLAW = new FoodProperties.Builder().nutrition(4).saturationMod(0.6F).build();
