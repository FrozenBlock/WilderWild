...
public final class WWSoundTypes {
	...
	public static final SoundType HOLLOWED_PALE_OAK_LOG = new SoundType(1F, 1F,
		WWSounds.BLOCK_HOLLOWED_PALE_OAK_LOG_BREAK,
		WWSounds.BLOCK_HOLLOWED_PALE_OAK_LOG_STEP,
		WWSounds.BLOCK_HOLLOWED_PALE_OAK_LOG_PLACE,
		WWSounds.BLOCK_HOLLOWED_PALE_OAK_LOG_HIT,
		WWSounds.BLOCK_HOLLOWED_PALE_OAK_LOG_FALL
	);
	...
	public static final SoundType PALE_OAK_WOOD = new SoundType(1F, 1F,
		...
		WWSounds.BLOCK_PALE_OAK_WOOD_PLACE,
		WWSounds.BLOCK_PALE_OAK_WOOD_HIT,
		WWSounds.BLOCK_PALE_OAK_WOOD_FALL
	);
	public static final SoundType PALE_OAK_WOOD_HANGING_SIGN = new SoundType(1F, 1F,
		WWSounds.BLOCK_PALE_OAK_WOOD_HANGING_SIGN_BREAK,
		WWSounds.BLOCK_PALE_OAK_WOOD_HANGING_SIGN_STEP,
		WWSounds.BLOCK_PALE_OAK_WOOD_HANGING_SIGN_PLACE,
		WWSounds.BLOCK_PALE_OAK_WOOD_HANGING_SIGN_HIT,
		WWSounds.BLOCK_PALE_OAK_WOOD_HANGING_SIGN_FALL
	);
