...
public final class WWSoundTypes {
	...
	public static final SoundType GEOTHERMAL_VENT = new SoundType(1F, 1F,
		WWSounds.BLOCK_GEOTHERMAL_VENT_BREAK,
		WWSounds.BLOCK_GEOTHERMAL_VENT_STEP,
		WWSounds.BLOCK_GEOTHERMAL_VENT_PLACE,
		WWSounds.BLOCK_GEOTHERMAL_VENT_HIT,
		WWSounds.BLOCK_GEOTHERMAL_VENT_FALL
	);
	...
	public static final SoundType CHERRY_LEAF_LITTER = new SoundType(1F, 1F,
		WWSounds.BLOCK_CHERRY_LEAF_LITTER_BREAK,
		WWSounds.BLOCK_CHERRY_LEAF_LITTER_STEP,
		WWSounds.BLOCK_CHERRY_LEAF_LITTER_PLACE,
		WWSounds.BLOCK_CHERRY_LEAF_LITTER_HIT,
		WWSounds.BLOCK_CHERRY_LEAF_LITTER_FALL
	);
	public static final SoundType PALE_OAK_LEAF_LITTER = new SoundType(1F, 1F,
		WWSounds.BLOCK_PALE_OAK_LEAF_LITTER_BREAK,
		WWSounds.BLOCK_PALE_OAK_LEAF_LITTER_STEP,
		WWSounds.BLOCK_PALE_OAK_LEAF_LITTER_PLACE,
	...
	public static final SoundType DRY_GRASS = new SoundType(1F, 1F,
		WWSounds.BLOCK_DRY_GRASS_BREAK,
		SoundEvents.GRASS_STEP,
		WWSounds.BLOCK_DRY_GRASS_PLACE,
		SoundEvents.GRASS_HIT,
		SoundEvents.GRASS_FALL
	);
