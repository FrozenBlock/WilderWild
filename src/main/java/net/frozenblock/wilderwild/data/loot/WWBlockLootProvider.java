...
public final class WWBlockLootProvider extends FabricBlockLootSubProvider {
	...
	public void generate() {
		...
		this.dropSelf(WWBlocks.HOLLOWED_POPLAR_LOG);
		this.dropSelf(WWBlocks.STRIPPED_HOLLOWED_POPLAR_LOG);
		...
		this.dropSelf(WWBlocks.PRICKLY_PEAR);
		...
		this.dropPottedContents(WWBlocks.POTTED_FIREFLY_BUSH);
