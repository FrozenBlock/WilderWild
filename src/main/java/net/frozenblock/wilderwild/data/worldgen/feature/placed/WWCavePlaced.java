		...
		GEOTHERMAL_VENT_NORTH.makeAndSetHolder(WWCaveConfigured.GEOTHERMAL_VENT_NORTH,
			...
			EnvironmentScanPlacement.scanningFor(
				...
				BlockPredicate.allOf(
					...
					BlockPredicate.matchesBlocks(Direction.SOUTH, WWBlocks.GABBRO, Blocks.MAGMA_BLOCK)
				),
		...
		GEOTHERMAL_VENT_EAST.makeAndSetHolder(WWCaveConfigured.GEOTHERMAL_VENT_EAST,
			...
			EnvironmentScanPlacement.scanningFor(
				...
				BlockPredicate.allOf(
					...
					BlockPredicate.matchesBlocks(Direction.WEST, WWBlocks.GABBRO, Blocks.MAGMA_BLOCK)
				),
				BlockPredicate.alwaysTrue(),
				12
			),
		...
		GEOTHERMAL_VENT_SOUTH.makeAndSetHolder(WWCaveConfigured.GEOTHERMAL_VENT_SOUTH,
			...
			EnvironmentScanPlacement.scanningFor(
				...
				BlockPredicate.allOf(
					...
					BlockPredicate.matchesBlocks(Direction.NORTH, WWBlocks.GABBRO, Blocks.MAGMA_BLOCK)
				),
				BlockPredicate.alwaysTrue(),
				12
			),
		...
		GEOTHERMAL_VENT_WEST.makeAndSetHolder(WWCaveConfigured.GEOTHERMAL_VENT_WEST,
			...
			EnvironmentScanPlacement.scanningFor(
				...
				BlockPredicate.allOf(
					...
					BlockPredicate.matchesBlocks(Direction.EAST, WWBlocks.GABBRO, Blocks.MAGMA_BLOCK)
				),
				BlockPredicate.alwaysTrue(),
				12
			),
