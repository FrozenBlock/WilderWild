...
public class FallingLeafTicker extends SilentTicker {
	...
	public void addAdditionalSaveData(@NotNull CompoundTag compound) {
		...
		BuiltInRegistries.BLOCK.byNameCodec().encodeStart(NbtOps.INSTANCE, this.leafLitter).resultOrPartial(WWConstants.LOGGER::error).ifPresent(
			tag -> compound.put("LeafLitterBlock", tag)
		);
