...
public class ScorchingMobEffect extends MobEffect {
	...
	public void applyEffectTick(LivingEntity livingEntity, int amplifier) {
		...
		if (livingEntity.getRandom().nextInt(i * j) == 0) {
			livingEntity.level().addParticle(WWParticleTypes.SCORCHING_FLAME, WWParticleTypes.SCORCHING_FLAME.getType().getOverrideLimiter(), livingEntity.getRandomX(0.5), livingEntity.getRandomY(), livingEntity.getRandomZ(0.5), 1, 1, 1);
		}
	}
