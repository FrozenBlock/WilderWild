...
public class SculkSensorTendrilModel<T extends SculkSensorTendrilEntity> extends EntityModel<SculkSensorTendrilEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("northeast", ModelPartBuilder.create().uv(0,0).cuboid(-4.0F, -8.0F, 0.0F, 8.0F, 8.0F, 0.002F), ModelTransform.pivot(-5.0F,24.0F,-5.0F));
        modelPartData.addChild("northwest", ModelPartBuilder.create().uv(0,0).cuboid(0.0F, -8.0F, -4.0F, 0.002F, 8.0F, 8.0F), ModelTransform.pivot(5.0F,24.0F,-5.0F));
        modelPartData.addChild("southeast", ModelPartBuilder.create().uv(0,0).cuboid(0.0F, -8.0F, -4.0F, 0.002F, 8.0F, 8.0F), ModelTransform.pivot(-5.0F,24.0F,5.0F));
        modelPartData.addChild("southwest", ModelPartBuilder.create().uv(0,0).cuboid(-4.0F, -8.0F, 0.0F, 8.0F, 8.0F, 0.002F), ModelTransform.pivot(5.0F,24.0F,5.0F));
    ...
    private void setTendrilPitches(SculkSensorTendrilEntity tendril, float animationProgress, float tickDelta) {
        ...
        this.northeast.pitch = f;
        this.northwest.roll = f;
        this.southeast.roll = f;
        this.southwest.pitch = f;
    }
