    ...
    public static final AnimationDefinition WATER_DYING = Builder.withLength(3.5F)
            ...
            .addAnimation(
                    ...
                    new AnimationChannel(
                            AnimationChannel.Targets.ROTATION,
                            new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.28F, KeyframeAnimations.posVec(-90.6636F, 9.917F, -1.8476F), AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(0.84F, KeyframeAnimations.posVec(-4.1947F, 21.3089F, 6.3256F), AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(1.44F, KeyframeAnimations.posVec(42.5707F, -3.6382F, 15.171F), AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(2.28F, KeyframeAnimations.posVec(49.4331F, -3.0042F, 15.7028F), AnimationChannel.Interpolations.CATMULLROM),
                            new Keyframe(3.28F, KeyframeAnimations.posVec(79.4684F, 3.3016F, 9.7983F), AnimationChannel.Interpolations.CATMULLROM)
                    )
            )
            .addAnimation(
                    "right_arm",
