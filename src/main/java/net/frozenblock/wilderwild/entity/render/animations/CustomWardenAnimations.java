    ...
    public static final Animation DYING = Builder.create(3.5F)
            .addBoneAnimation(
                    ...
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41829(-42.7453F, -5.5223F, 27.5827F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "body",
                    new Transformation(
                            ...
                            new Keyframe(3.5F, AnimationHelper.method_41823(12.0F, -500F, 8.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "head",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41829(-17.5093F, -0.434F, 2.4621F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "head",
            ...
            .addBoneAnimation(
                    ...
                    new Transformation(
                            Transformation.Targets.ROTATE,
                            new Keyframe(0.0F, AnimationHelper.method_41829(0.0F, 0.0F, 0.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(0.297F, AnimationHelper.method_41829(-2.5F, -15.0F, 0.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(0.6832F, AnimationHelper.method_41829(27.4879F, 10.6357F, 9.5747F), Transformation.Interpolations.field_37885),
                            new Keyframe(0.99F, AnimationHelper.method_41829(53.34F, 33.8768F, 14.39F), Transformation.Interpolations.field_37885),
                            new Keyframe(1.307F, AnimationHelper.method_41829(53.34F, 33.88F, 14.39F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.17F, AnimationHelper.method_41829(-25.05F, -51.875F, -20.6694F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "left_ear",
                    new Transformation(
                            Transformation.Targets.TRANSLATE,
                            new Keyframe(1.455F, AnimationHelper.method_41823(0.0F, 0.0F, 0.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.1583F, AnimationHelper.method_41823(-2.0F, 0.0F, 0.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "right_arm",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41829(-58.1913F, -52.867F, 72.31F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "right_arm",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41823(0.0F, 4.0F, 2.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "left_arm",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41829(20.6913F, 10.8284F, -137.6989F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "left_arm",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41823(-3.0F, 0.0F, 0.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "right_leg",
            ...
            .addBoneAnimation(
                    ...
                    new Transformation(
                            ...
                            new Keyframe(0.84F, AnimationHelper.method_41823(8.0F, -23F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(1.4356F, AnimationHelper.method_41823(8.0F, -44.8F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(1.8812F, AnimationHelper.method_41823(8.0F, -52.54F, 3.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.4455F, AnimationHelper.method_41823(8.0F, -60.0F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.64F, AnimationHelper.method_41823(8.0F, -60.0F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.84F, AnimationHelper.method_41823(8.0F, -42.0F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(2.95F, AnimationHelper.method_41823(8.0F, -81.58F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(3.198F, AnimationHelper.method_41823(8.0F, -196.77F, 1.0F), Transformation.Interpolations.field_37885),
                            new Keyframe(3.5F, AnimationHelper.method_41823(8.0F, -490.0F, 1.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "left_leg",
                    new Transformation(
                            ...
                            new Keyframe(2.64F, AnimationHelper.method_41829(-128.1353F, -32.1013F, 8.7832F), Transformation.Interpolations.field_37884)
                    )
            )
            .addBoneAnimation(
                    "left_leg",
                    new Transformation(
                            ...
                            new Keyframe(3.5F, AnimationHelper.method_41823(8.0F, -495.0F, 0.0F), Transformation.Interpolations.field_37884)
                    )
            )
            .build();
    ...
    public static final Animation SWIMMING = Builder.create(0.0F).build();
        ...
        public static final Animation SWIMMING_SNIFFING = Builder.create(4.16F). //CURRENTLY NO DIFFERENCE IN ANIMATIONS
                ...
                .addBoneAnimation("left_arm", new Transformation(Transformation.Targets.ROTATE,
                        ...
                        new Keyframe(3.32F, AnimationHelper.method_41829(0.0F, 0.0F, 0.0F), Transformation.Interpolations.field_37885))).build();
}
