...
public class TumbleweedModel<T extends Tumbleweed> extends HierarchicalModel<T> {
	...
	public void prepareMobModel(T entity, float limbSwing, float limbSwingAmount, float partialTick) {
		this.xRotation.xRot = Mth.lerp(partialTick, entity.prevPitch, entity.getPitch()) * pi180;
		this.yRotation.yRot = Mth.lerp(partialTick, entity.prevYaw, entity.getYaw()) * pi180;
		this.xRotation.zRot = Mth.lerp(partialTick, entity.prevRoll, entity.getRoll()) * pi180;
	}
