...
public class FireflyBrain {
    ...
    private static boolean shouldGoTowardsHome(LivingEntity firefly, Brain<?> brain, GlobalPos pos) {
        ...
        return world.getRegistryKey() == pos.getDimension() && pos.getPos() == fireflyEntity.home;
    }
