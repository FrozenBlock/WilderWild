...
public final class EarlyRiser implements Runnable {
    ...
    public void run() {
		...
		ClassTinkerers.enumBuilder(mobCategory, String.class, int.class, boolean.class, boolean.class, int.class).addEnum("WILDERWILDTUMBLEWEED", "wilderwildtumbleweed", 14, true, false, 42).build();
	}
}
