...
public final class EarlyRiser implements Runnable {
    ...
    public void run() {
        ...
        /*implement firefly spawn rate config here*/ ClassTinkerers.enumBuilder(mobCategory, String.class, int.class, boolean.class, boolean.class, int.class).addEnum("WILDERWILDFIREFLIES", "wilderwildfireflies", 56, true, false, 80).build();
