...
public final class WilderWildClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
		NewSplahes.addNewSplashLocation(WilderSharedConstants.id("texts/splashes.txt"));
		NewPanoramas.addNewPanorama(WilderSharedConstants.id("textures/gui/title/first/panorama"));
