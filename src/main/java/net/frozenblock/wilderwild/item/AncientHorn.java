...
public class AncientHorn extends InstrumentItem {
    ...
    public static final int ECHOER_COOLDOWN = 580;
    ...
    public InteractionResultHolder<ItemStack> use(@NotNull Level level, @NotNull Player user, @NotNull InteractionHand hand) {
        ...
        if (optional.isPresent()) {
            ...
            if (level instanceof ServerLevel server) {
                ...
                FrozenSoundPackets.createMovingRestrictionLoopingSound(server, projectileEntity, RegisterSounds.ENTITY_ANCIENT_HORN_PROJECTILE_LOOP, SoundSource.NEUTRAL, 1.0F, 1.0F, FrozenMain.id("default"));
