...
package net.frozenblock.wilderwild.levelgen.feature.configuration;
...
public record LargeMesogleaConfiguration(
	...
	public static final Codec<LargeMesogleaConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		...
		FloatProviders.codec(0.1F, 10F).fieldOf("stalagmite_bluntness").forGetter(config -> config.stalagmiteBluntness),
