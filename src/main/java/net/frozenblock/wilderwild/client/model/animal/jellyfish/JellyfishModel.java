...
public class JellyfishModel extends EntityModel<JellyfishRenderState> {
	protected static final int JELLYFISH_TENTACLES = WWEntityConfig.get().jellyfish.jellyfishTentacles;
	...
	public void setupAnim(JellyfishRenderState renderState) {
		...
		final ModelPart[] visibleTentacles = !WWEntityConfig.Client.JELLYFISH_PLANE_TENTACLES && !renderState.isBaby ? this.tentacles : this.planeTentacles;
		final ModelPart[] invisibleTentacles = !WWEntityConfig.Client.JELLYFISH_PLANE_TENTACLES && !renderState.isBaby ? this.planeTentacles : this.tentacles;
