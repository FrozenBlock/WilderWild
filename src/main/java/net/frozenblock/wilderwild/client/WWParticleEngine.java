...
public final class WWParticleEngine {
	...
	public static void init() {
		...
		// BACKPORT
		particleRegistry.register(WWParticleTypes.DUST_PLUME, DustPlumeParticle.Provider::new);
		particleRegistry.register(WWParticleTypes.WHITE_SMOKE, WhiteSmokeParticle.Provider::new);
	}
}
