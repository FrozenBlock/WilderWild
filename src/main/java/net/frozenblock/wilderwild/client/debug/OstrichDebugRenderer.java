...
package net.frozenblock.wilderwild.client.debug;
...
public final class OstrichDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
	...
	private static void drawLine(
		...
		vertexConsumer.vertex(matrices.last().pose(), (float)(start.x - cameraX), (float)(start.y - cameraY), (float)(start.z - cameraZ)).color(color);
		vertexConsumer.vertex(matrices.last().pose(), (float)(target.x - cameraX), (float)(target.y - cameraY), (float)(target.z - cameraZ)).color(color);
	}
}
