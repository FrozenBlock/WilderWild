...
public final class WWBlockLootProvider extends FabricBlockLootTableProvider {
	...
	public void generate() {
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantValue.exactly(1F))
						.add(
							LootItem.lootTableItem(WWBlocks.PALM_FRONDS).when(HAS_SHEARS_OR_SILK_TOUCH)
						)
				).withPool(
					LootPool.lootPool()
						.when(HAS_NO_SHEARS_OR_SILK_TOUCH)
		...
		this.add(WWBlocks.ALGAE,
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantValue.exactly(1F))
						.add(LootItem.lootTableItem(WWBlocks.ALGAE).when(HAS_SHEARS_OR_SILK_TOUCH))
				)
		);
		this.add(WWBlocks.POLLEN, block -> this.createMultifaceBlockDrops(block, HAS_SHEARS_OR_SILK_TOUCH));
		...
		this.add(WWBlocks.PINK_GIANT_GLORY_OF_THE_SNOW, block -> this.createMultifaceBlockDrops(block, HAS_SHEARS_OR_SILK_TOUCH));
		this.add(WWBlocks.VIOLET_BEAUTY_GLORY_OF_THE_SNOW, block -> this.createMultifaceBlockDrops(block, HAS_SHEARS_OR_SILK_TOUCH));
		this.add(WWBlocks.ALBA_GLORY_OF_THE_SNOW, block -> this.createMultifaceBlockDrops(block, HAS_SHEARS_OR_SILK_TOUCH));
		...
		this.dropPottedContents(WWBlocks.POTTED_GRASS);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.apply(
							CopyNbtFunction.copyData(ContextNbtProvider.BLOCK_ENTITY).copy("Fireflies", "Fireflies")
								.when(HAS_SILK_TOUCH)
						)
				)
		);
		...
		this.add(WWBlocks.YELLOW_MAPLE_LEAF_LITTER,
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantValue.exactly(1F))
						.add(LootItem.lootTableItem(WWBlocks.YELLOW_MAPLE_LEAF_LITTER).when(HAS_SHEARS_OR_SILK_TOUCH))
				)
		);
		this.add(WWBlocks.ORANGE_MAPLE_LEAF_LITTER,
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantValue.exactly(1F))
						.add(LootItem.lootTableItem(WWBlocks.ORANGE_MAPLE_LEAF_LITTER).when(HAS_SHEARS_OR_SILK_TOUCH))
				)
		);
		this.add(WWBlocks.RED_MAPLE_LEAF_LITTER,
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.setRolls(ConstantValue.exactly(1F))
						.add(LootItem.lootTableItem(WWBlocks.RED_MAPLE_LEAF_LITTER).when(HAS_SHEARS_OR_SILK_TOUCH))
				)
		);
	}
