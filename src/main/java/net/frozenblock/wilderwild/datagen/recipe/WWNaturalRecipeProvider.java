...
public final class WWNaturalRecipeProvider {
	...
	static void buildRecipes(RecipeOutput exporter) {
		oneToOneConversionRecipe(exporter, Items.ORANGE_DYE, WWBlocks.LANTANAS, "orange_dye");

		oneToOneConversionRecipe(exporter, Items.PURPLE_DYE, WWBlocks.PHLOX, "purple_dye");

		oneToOneConversionRecipe(exporter, Items.YELLOW_DYE, WWBlocks.WILDFLOWERS, "yellow_dye");
		...
		RecipeProvider.carpet(exporter, WWBlocks.AUBURN_MOSS_CARPET, WWBlocks.AUBURN_MOSS_BLOCK);

		RecipeProvider.twoByTwoPacker(exporter, RecipeCategory.BUILDING_BLOCKS, Blocks.ICE, WWBlocks.ICICLE);
	}
