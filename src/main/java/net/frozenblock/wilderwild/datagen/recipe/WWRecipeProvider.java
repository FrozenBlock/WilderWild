		...
		return new RecipeProvider(registries, exporter) {
			...
			public void buildRecipes() {
				...
				ShapedRecipeUtil.withResultPatch(
					this.shaped(RecipeCategory.COMBAT, WWItems.ANCIENT_HORN)
						...
						.pattern("#I#")
						.pattern("I#I")
						.unlockedBy(RecipeProvider.getHasName(WWItems.ANCIENT_HORN_FRAGMENT), this.has(WWItems.ANCIENT_HORN_FRAGMENT)),
					DataComponentPatch.builder()
						.set(DataComponents.INSTRUMENT, registries.lookupOrThrow(Registries.INSTRUMENT).getOrThrow(WWItems.ANCIENT_HORN_INSTRUMENT))
						.build()
				).save(exporter);
