...
public final class HollowedLogRecipeProvider {
	...
	static void buildRecipes(RecipeProvider provider, RecipeOutput output) {
		...
		planksFromHollowed(provider, WWItemTags.HOLLOWED_BAOBAB_LOGS, WWItems.BAOBAB_PLANKS, output, "baobab");
		...
		planksFromHollowed(provider, WWItemTags.HOLLOWED_CYPRESS_LOGS, WWItems.CYPRESS_PLANKS, output, "cypress");
		...
		planksFromHollowed(provider, WWItemTags.HOLLOWED_MAPLE_LOGS, WWItems.MAPLE_PLANKS, output, "maple");
		...
		planksFromHollowed(provider, WWItemTags.HOLLOWED_PALM_LOGS, WWItems.PALM_PLANKS, output, "palm");
		...
		planksFromHollowed(provider, WWItemTags.HOLLOWED_WILLOW_LOGS, WWItems.WILLOW_PLANKS, output, "willow");
