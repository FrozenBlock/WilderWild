...
public final class WWBiomeTagProvider extends FrozenBiomeTagProvider {
	...
	private void generateBiomeTags() {
		...
		this.getOrCreateTagBuilder(WWBiomeTags.NORMAL_SAVANNA)
			.add(Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU)
			.addOptional(WWBiomes.ARID_SAVANNA);

		this.getOrCreateTagBuilder(WWBiomeTags.SHORT_TAIGA)
			.add(Biomes.TAIGA);

		this.getOrCreateTagBuilder(WWBiomeTags.SHORT_TAIGA_SNOWY)
	...
	private void generateMusicPoolTags() {
		...
		this.getOrCreateTagBuilder(WWBiomeTags.HAS_BADLANDS_MUSIC)
			.addOptional(Biomes.BADLANDS)
			.addOptional(Biomes.ERODED_BADLANDS)
			.addOptional(Biomes.WOODED_BADLANDS);

		this.getOrCreateTagBuilder(WWBiomeTags.HAS_DESERT_MUSIC)
		...
		this.getOrCreateTagBuilder(WWBiomeTags.HAS_FROZEN_OCEAN_MUSIC)
	...
	private void generateFeatureTags() {
		...
		this.getOrCreateTagBuilder(WWBiomeTags.HAS_UNCOMMON_LEAF_LITTER)
			.add(Biomes.FOREST)
			.add(Biomes.DARK_FOREST)
			.addOptional(WWBiomes.MIXED_FOREST)
			.addOptional(WWBiomes.OLD_GROWTH_DARK_FOREST);

		this.getOrCreateTagBuilder(WWBiomeTags.HAS_SPRUCE_LEAF_LITTER)
			.add(Biomes.TAIGA)
			.add(Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.OLD_GROWTH_PINE_TAIGA)
			.addOptional(WWBiomes.DARK_TAIGA)
			.addOptional(WWBiomes.BIRCH_TAIGA)
		...
		this.getOrCreateTagBuilder(WWBiomeTags.HAS_DARK_OAK_LEAF_LITTER)
			.add(Biomes.DARK_FOREST)
			.addOptional(WWBiomes.OLD_GROWTH_DARK_FOREST);

		this.getOrCreateTagBuilder(WWBiomeTags.HAS_PALE_OAK_LEAF_LITTER)
			.add(Biomes.PALE_GARDEN);
		...
		this.getOrCreateTagBuilder(WWBiomeTags.HAS_FOREST_BIG_BUSH_COMMON)
			.addOptional(WWBiomes.OLD_GROWTH_DARK_FOREST);
