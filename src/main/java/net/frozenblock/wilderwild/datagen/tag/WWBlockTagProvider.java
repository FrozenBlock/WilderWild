...
public final class WWBlockTagProvider extends FabricTagProvider.BlockTagProvider {
	...
	private void generateSounds() {
		...
		this.builder(WWBlockTags.SOUND_LEAVES)
			...
			.add(WWBlocks.PALM_FRONDS.builtInRegistryHolder().key())
			.add(WWBlocks.YELLOW_MAPLE_LEAVES.builtInRegistryHolder().key())
			.add(WWBlocks.ORANGE_MAPLE_LEAVES.builtInRegistryHolder().key())
			.add(WWBlocks.RED_MAPLE_LEAVES.builtInRegistryHolder().key())
			.add(Blocks.PALE_OAK_LEAVES.builtInRegistryHolder().key())
		...
		this.builder(WWBlockTags.SOUND_FLOWER)
			...
			.add(Blocks.PINK_PETALS.builtInRegistryHolder().key())
