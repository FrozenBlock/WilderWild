...
public final class WWBlockTagProvider extends FabricTagProvider.BlockTagProvider {
	...
	private void generateSounds() {
		this.valueLookupBuilder(WWBlockTags.SOUND_COCONUT)
			.add(WWBlocks.COCONUT)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_SANDSTONE)
			.add(Blocks.SANDSTONE)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_MUSHROOM_BLOCK)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_MUSHROOM)
			.add(Blocks.RED_MUSHROOM)
			.add(Blocks.BROWN_MUSHROOM)
			.add(WWBlocks.PALE_MUSHROOM)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_COARSE_DIRT)
			.add(Blocks.COARSE_DIRT)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_CACTUS)
			.add(Blocks.CACTUS)
			.add(WWBlocks.PRICKLY_PEAR_CACTUS)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_SAPLING)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_LEAVES)
		...
		this.valueLookupBuilder(WWBlockTags.SOUND_FLOWER)
