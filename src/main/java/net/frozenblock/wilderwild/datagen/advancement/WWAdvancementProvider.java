...
public final class WWAdvancementProvider extends FabricAdvancementProvider {
	...
	public void generateAdvancement(Consumer<Advancement> writer) {
		Advancement adventure = Advancement.Builder.advancement().build(WWConstants.vanillaId("adventure/root"));
		Advancement husbandry = Advancement.Builder.advancement().build(WWConstants.vanillaId("husbandry/root"));
		...
		Advancement.Builder.advancement()
			...
			.addCriterion("crab_bucket", FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(WWItems.CRAB_BUCKET).build()))
		...
		Advancement.Builder.advancement()
			...
			.addCriterion("jellyfish_bucket", FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(WWItems.JELLYFISH_BUCKET).build()))
