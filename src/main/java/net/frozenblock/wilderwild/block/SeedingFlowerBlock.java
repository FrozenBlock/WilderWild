...
public class SeedingFlowerBlock extends FlowerBlock {
	...
	public SeedingFlowerBlock(@NotNull MobEffect suspiciousStewEffect, int effectDuration, Block nonSeedingFlower, @NotNull Properties settings) {
		super(suspiciousStewEffect, effectDuration, settings);
		this.nonSeedingFlower = nonSeedingFlower;
	}

	public SeedingFlowerBlock(List<EffectEntry> suspiciousStewEffects, Block nonSeedingFlower, BlockBehaviour.Properties properties) {
