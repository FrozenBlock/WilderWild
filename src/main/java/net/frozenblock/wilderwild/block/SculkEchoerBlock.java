...
public class SculkEchoerBlock extends BlockWithEntity implements Waterloggable {
    ...
    private static final VoxelShape SHAPE_UPSIDEDOWN = VoxelShapes.union(Block.createCuboidShape(16.0D, 16.0D, 16.0D, 0.0D, 11.0D, 0.0D), Block.createCuboidShape(15.0D, 11.0D, 15.0D, 1.0D, 5.0D, 1.0D));
