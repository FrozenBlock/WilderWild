...
public class OstrichSpecificSensor extends Sensor<LivingEntity> {
	...
	public Set<MemoryModuleType<?>> requires() {
		return ImmutableSet.of(WWFabricMemoryModuleTypes.NEARBY_OSTRICHES.get(), MemoryModuleType.NEAREST_LIVING_ENTITIES);
	}
	...
	protected void doTick(ServerLevel level, LivingEntity entity) {
		...
		brain.setMemory(WWFabricMemoryModuleTypes.NEARBY_OSTRICHES.get(), ostriches);
	}
}
