...
public final class WWDataFixer {
	...
	public static void applyDataFixes(final ModContainer mod) {
		...
		final Schema schemaV15 = builder.addSchema(15, NamespacedSchema::new);
		builder.addFixer(new OsseousSculkStateFix(schemaV15, "osseous_sculk_axis_to_direction", WWConstants.id("osseous_sculk")));

		final Schema schemaV16 = builder.addSchema(16, NamespacedSchema::new);
		...
		final Schema schemaV17 = builder.addSchema(17, NamespacedSchema::new);
		...
		final Schema schemaV22 = builder.addSchema(22, NamespacedSchema::new);
		...
		final Schema schemaV25 = builder.addSchema(25, NamespacedSchema::new);
		...
		final Schema schemaV27 = builder.addSchema(27, NamespacedSchema::new);
		...
		final Schema schemaV28 = builder.addSchema(28, NamespacedSchema::new);
