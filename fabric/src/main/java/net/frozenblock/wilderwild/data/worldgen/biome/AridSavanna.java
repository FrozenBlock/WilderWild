...
public final class AridSavanna extends FrozenLibBiome {
	...
	public void addFeatures(BiomeGenerationSettings.Builder features) {
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.ARID_SAVANNA_TREES.getKey());
		...
		features.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, WWPlacedFeatures.PATCH_ARID_CACTUS.getKey());
	...
	public void injectToOverworld(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> parameters) {
		...
		if (!WWWorldgenConfig.ARID_SAVANNA_GENERATION.get()) return;
