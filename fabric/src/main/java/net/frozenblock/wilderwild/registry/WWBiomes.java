...
import net.frozenblock.wilderwild.data.worldgen.biome.AridForest;
import net.frozenblock.wilderwild.data.worldgen.biome.AridSavanna;
import net.frozenblock.wilderwild.data.worldgen.biome.BirchJungle;
import net.frozenblock.wilderwild.data.worldgen.biome.BirchTaiga;
import net.frozenblock.wilderwild.data.worldgen.biome.CypressWetlands;
import net.frozenblock.wilderwild.data.worldgen.biome.DarkBirchForest;
import net.frozenblock.wilderwild.data.worldgen.biome.DarkTaiga;
...
import net.frozenblock.wilderwild.data.worldgen.biome.MixedForest;
import net.frozenblock.wilderwild.data.worldgen.biome.Oasis;
import net.frozenblock.wilderwild.data.worldgen.biome.OldGrowthBirchTaiga;
import net.frozenblock.wilderwild.data.worldgen.biome.OldGrowthDarkForest;
import net.frozenblock.wilderwild.data.worldgen.biome.ParchedForest;
import net.frozenblock.wilderwild.data.worldgen.biome.Rainforest;
import net.frozenblock.wilderwild.data.worldgen.biome.SemiBirchForest;
import net.frozenblock.wilderwild.data.worldgen.biome.SnowyDyingForest;
import net.frozenblock.wilderwild.data.worldgen.biome.SnowyDyingMixedForest;
import net.frozenblock.wilderwild.data.worldgen.biome.SnowyOldGrowthPineTaiga;
import net.frozenblock.wilderwild.data.worldgen.biome.SparseBirchJungle;
import net.frozenblock.wilderwild.data.worldgen.biome.SparseForest;
import net.frozenblock.wilderwild.data.worldgen.biome.TemperateRainforest;
import net.frozenblock.wilderwild.data.worldgen.biome.Tundra;
import net.frozenblock.wilderwild.data.worldgen.biome.WarmBeach;
import net.frozenblock.wilderwild.data.worldgen.biome.WarmRiver;
